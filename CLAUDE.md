...
1. Modify source files in appropriate service/framework directories
2. Update BUILD.gn files if adding new source files
3. Build with ninja to verify compilation
4. Write unit tests in corresponding `test/` directories
5. Use mock facilities in `test/facility/` for dependency isolation

## Related Documentation

- `multimodalinput_input/README.md` - Basic module overview
- `multimodalinput_thread_model_analysis_report.md` - Threading model details
- `Android_Input_vs_Multimodalinput_Comparison_Report.md` - Comparison with Android input system
