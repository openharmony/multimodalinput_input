...
void udev_set_log_fn(struct udev *udev, void (*log_fn)(struct udev *udev, int priority, const char *file, int line,
...
/**
 * udev_list access to libudev generated lists
 */
...
/**
 * udev_monitor access to kernel uevents and udev events
 */
struct udev_monitor;
...
/**
 * udev_enumerate search sysfs for specific devices and provide a sorted list
 */
...
/**
 * udev_queue access to the currently running udev events
 */
struct udev_queue;
...
int udev_queue_get_seqnum_is_finished(struct udev_queue *udev_queue, unsigned long long int seqnum)
    __attribute__((deprecated));
int udev_queue_get_seqnum_sequence_is_finished(struct udev_queue *udev_queue, unsigned long long int start,
    unsigned long long int end) __attribute__((deprecated));
...
/**
 * udev_hwdb access to the static hardware properties database
 */
struct udev_hwdb;
...
/**
 * udev_util udev specific utilities
 */
