...
{
    int32_t argc = 4;
    char argv[4][16] = {"functionName", "aisensor", "all", "2"};
    InjectionEventDispatch injectionEventDispatch;
...
{
    int32_t argc = 5;
    char argv[5][16] = { "functionName", "aisensor", "each" , "1103", "1"};
    InjectionEventDispatch injectionEventDispatch;
    std::vector<std::string> argvs;
    for (int32_t i = 0; i < argc; i++) {
        argvs.push_back(argv[i]);
...
{
    int32_t argc = 4;
    char argv[4][16] = {"functionName", "knuckle", "all", "2"};
    InjectionEventDispatch injectionEventDispatch;
    std::vector<std::string> argvs;
    for (int32_t i = 0; i < argc; i++) {
        argvs.push_back(argv[i]);
...
{
    int32_t argc = 5;
    char argv[5][16] = { "functionName", "knuckle", "each", "4001", "1" };
    InjectionEventDispatch injectionEventDispatch;
    std::vector<std::string> argvs;
    for (int32_t i = 0; i < argc; i++) {
        argvs.push_back(argv[i]);
