...
{
    static constexpr int32_t ABS_MAX_X = 480;
    static constexpr int32_t ABS_MAX_Y = 960;
    static constexpr int32_t ABS_PRESSURE_MAX = 100;
    static constexpr int32_t ABS_MT_ORIENTATION_MIN = -90;
    static constexpr int32_t ABS_MT_ORIENTATION_MAX = 90;
    static constexpr int32_t ABS_MT_BLOB_ID_MAX = 10;
    static constexpr int32_t ABS_MT_TRACKING_ID_MAX = 9;
    static constexpr int32_t ABS_TOOL_TYPE_MAX = 15;
    static constexpr int32_t ABS_MT_SLOT_MAX = 10;
