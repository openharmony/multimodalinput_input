...
{
    const int ABS_MAX_X = 480;
    const int ABS_MAX_Y = 960;
    const int ABS_PRESSURE_MAX = 100;
    const int ABS_MT_ORIENTATION_MIN = -90;
    const int ABS_MT_ORIENTATION_MAX = 90;
    const int ABS_MT_BLOB_ID_MAX = 10;
    const int ABS_MT_TRACKING_ID_MAX = 9;
