...
{
    static constexpr int32_t ABS_MAX_XY = 16383;
    static constexpr int32_t ABS_FUZZ = 63;
    static constexpr int32_t ABS_FLAT = 1023;
    static constexpr int32_t ABS_MAX_RZ = 255;
    static constexpr int32_t ABS_FLAT_RZ = 15;
