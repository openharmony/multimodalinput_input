...
GeneralUwbRemoteControl RemoteControlTransformProcessorTestWithMock::vUwbRemoteControl_;
LibinputWrapper RemoteControlTransformProcessorTestWithMock::libinput_;
...
void RemoteControlTransformProcessorTestWithMock::SetupUwbRemoteControl()
{
...
void RemoteControlTransformProcessorTestWithMock::CloseUwbRemoteControl()
{
 ...
 * @tc.require:
 */
HWTEST_F(RemoteControlTransformProcessorTestWithMock, Remote_ControlTransformProcessorTest_OnEvent_001,
        TestSize.Level1)
{
    CALL_TEST_DEBUG;
 ...
 * @tc.require:
 */
HWTEST_F(RemoteControlTransformProcessorTestWithMock, Remote_ControlTransformProcessorTest_OnEventTouchMotion_001,
        TestSize.Level1)
{
    int32_t deviceId = 7;
    Remote_ControlTransformProcessor processor(deviceId);
 ...
 * @tc.require:
 */
HWTEST_F(RemoteControlTransformProcessorTestWithMock, Remote_ControlTransformProcessorTest_OnEventTouchMotion_002,
        TestSize.Level1)
{
    CALL_TEST_DEBUG;
    libinput_.DrainEvents();
 ...
 * @tc.require:
 */
HWTEST_F(RemoteControlTransformProcessorTestWithMock, Remote_ControlTransformProcessorTest_OnEventTouchMotion_003,
    TestSize.Level1)
{
    CALL_TEST_DEBUG;
    libinput_.DrainEvents();
