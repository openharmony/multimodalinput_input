...
#ifndef TOUCH_GESTURE_INTERFACE_H
...
namespace OHOS {
namespace MMI {
class TouchGestureInterface final : public ITouchGestureManager {
public:
    static std::shared_ptr<TouchGestureInterface> Load(IInputServiceContext *env);

    TouchGestureInterface() = default;
    ~TouchGestureInterface() override = default;
    DISALLOW_COPY_AND_MOVE(TouchGestureInterface);
...
#endif // TOUCH_GESTURE_INTERFACE_H