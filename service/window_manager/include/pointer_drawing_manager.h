...
private:
    ...
    int32_t DrawDynamicHardwareCuror(std::shared_ptr<ScreenPointer> sp, const RenderConfig &cfg);
    int32_t DrawDynamicSoftwareCuror(std::shared_ptr<ScreenPointer> sp, const RenderConfig &cfg);
