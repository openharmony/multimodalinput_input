...
HWTEST_F(PointerDrawingManagerExTest, InputWindowsManagerTest_SwitchPointerStyle_01, TestSize.Level1)
{
    ...
    int32_t size = pointerDrawingManager.GetPointerSize(0);
    size = -1;
...
HWTEST_F(PointerDrawingManagerExTest, InputWindowsManagerTest_SetPointerStyle_001, TestSize.Level1)
{
    ...
    int32_t pid = 1;
    int32_t windowId = 2;
    bool ret1 = CursorDrawingInformation::GetInstance().IsPointerStyleParamValid(windowId, pointerStyle);
    EXPECT_TRUE(ret1);
...
HWTEST_F(PointerDrawingManagerExTest, InputWindowsManagerTest_IsPointerStyleParamValid_01, TestSize.Level1)
{
    ...
    pointerStyle.id = 46;
    bool ret2 = CursorDrawingInformation::GetInstance().IsPointerStyleParamValid(windowId, pointerStyle);
    EXPECT_TRUE(ret2);

    windowId = -3;
    bool ret3 = CursorDrawingInformation::GetInstance().IsPointerStyleParamValid(windowId, pointerStyle);
    EXPECT_FALSE(ret3);
}
...
HWTEST_F(PointerDrawingManagerExTest, InputWindowsManagerTest_SetMouseHotSpot_04, TestSize.Level1)
{
    ...
    int32_t hotSpotX = -3;
    int32_t hotSpotY = -4;
    CursorDrawingInformation& information = CursorDrawingInformation::GetInstance();
    information.userIcon_ = nullptr;
    int32_t ret = pointerDrawingManager.SetMouseHotSpot(pid, windowId, hotSpotX, hotSpotY);
    ASSERT_EQ(ret, RET_ERR);
}
...
HWTEST_F(PointerDrawingManagerExTest, InputWindowsManagerTest_SetPointerColor_01, TestSize.Level1)
{
    ...
    int32_t userId = 0;
    int32_t ret = pointerDrawingManager.SetPointerColor(userId, color);
    EXPECT_EQ(ret, RET_OK);
}
...
HWTEST_F(PointerDrawingManagerExTest, InputWindowsManagerTest_SetPointerColor_02, TestSize.Level1)
{
    ...
    EXPECT_EQ(ret, RET_OK);
    int32_t userId = 0;
    int32_t ret2 = pointerDrawingManager.SetPointerColor(userId, color);
    EXPECT_EQ(ret2, RET_OK);
}
...
HWTEST_F(PointerDrawingManagerExTest, InputWindowsManagerTest_SetPointerSize_02, TestSize.Level1)
{
    ...
    EXPECT_EQ(ret, RET_OK);
    pointerDrawingManager.surfaceNode_ = nullptr;
    EXPECT_EQ(pointerDrawingManager.SetPointerSize(0, size), RET_OK);
}
...
HWTEST_F(PointerDrawingManagerExTest, PointerDrawingManagerExTest_GetIconStyle, TestSize.Level1)
{
    ...
    IconStyle iconStyle;
    CursorDrawingInformation::GetInstance().mouseIcons_.insert(std::make_pair(mouseStyle, iconStyle));
...
HWTEST_F(PointerDrawingManagerExTest, PointerDrawingManagerExTest_SetPointerVisible, TestSize.Level1)
{
    ...
    ASSERT_EQ(CursorDrawingInformation::GetInstance().SetPointerVisible(pid, visible, priority, isHap), RET_OK);
    pid = 5;
    CursorDrawingInformation::GetInstance().hapPidInfos_.pop_front();
    ASSERT_EQ(CursorDrawingInformation::GetInstance().SetPointerVisible(pid, visible, priority, isHap), RET_OK);
}
...
HWTEST_F(PointerDrawingManagerExTest, PointerDrawingManagerExTest_SetMouseIcon, TestSize.Level1)
{
    ...
    int32_t userId = 0;
    EXPECT_EQ(CursorDrawingInformation::GetInstance().SetMouseIcon(userId, pid, windowId, curPixelMap), RET_ERR);
}
...
HWTEST_F(PointerDrawingManagerExTest, PointerDrawingManagerExTest_SetMouseHotSpot_003, TestSize.Level1)
{
    ...
    int32_t hotSpotY = 100;
    CursorDrawingInformation& information = CursorDrawingInformation::GetInstance();
    information.userIcon_ = std::make_unique<OHOS::Media::PixelMap>();
    EXPECT_EQ(pointerDrawMgr.SetMouseHotSpot(pid, windowId, hotSpotX, hotSpotY), RET_ERR);
}
...
/**
@tc.name: PointerDrawingManagerExTest_RA_CheckDifferetDisplayId_001
@tc.desc: Test the function CheckDifferetDisplayId
@tc.type: FUNC
@tc.require:
*/
HWTEST_F(PointerDrawingManagerExTest, PointerDrawingManagerExTest_RA_CheckDifferetDisplayId_001,
    TestSize.Level1)
{
    CALL_TEST_DEBUG;
    PointerDrawingManager pointerDrawMgr;
...
/**
@tc.name: PointerDrawingManagerExTest_RA_GetResampleCoords_001
@tc.desc: Test the function GetResampleCoords
@tc.type: FUNC
@tc.require:
*/
HWTEST_F(PointerDrawingManagerExTest, PointerDrawingManagerExTest_RA_GetResampleCoords_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    PointerDrawingManager pointerDrawMgr;
    int32_t curX = 10;
