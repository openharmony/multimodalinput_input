...
/**
 * @tc.name: ScreenPointerTest_DestroyPointerWindow_001
 * @tc.desc: Test DestroyPointerWindow with valid surface node
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(ScreenPointerTest, ScreenPointerTest_DestroyPointerWindow_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    hwcmgr_ptr_t hwcmgr = std::make_shared<HardwareCursorPointerManager>();
    ASSERT_NE(hwcmgr, nullptr);
    ...
    screenpointer->surfaceNode_ = Rosen::RSSurfaceNode::Create(surfaceNodeConfig, surfaceNodeType, true, false,
        nullptr);
    ASSERT_NE(screenpointer->surfaceNode_, nullptr);

    ASSERT_NO_FATAL_FAILURE(screenpointer->DestroyPointerWindow());
    EXPECT_EQ(screenpointer->surfaceNode_, nullptr);
    EXPECT_EQ(screenpointer->rsUIDirector_, nullptr);
    EXPECT_EQ(screenpointer->rsUIContext_, nullptr);
}

/**
 * @tc.name: ScreenPointerTest_DestroyPointerWindow_002
 * @tc.desc: Test DestroyPointerWindow with null surface node
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(ScreenPointerTest, ScreenPointerTest_DestroyPointerWindow_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    hwcmgr_ptr_t hwcmgr = std::make_shared<HardwareCursorPointerManager>();
    ASSERT_NE(hwcmgr, nullptr);
...
/**
 * @tc.name: ScreenPointerTest_InitRSUIContext_ScreenChanged_001
 * @tc.desc: Test InitRSUIContext when screen is changed
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(ScreenPointerTest, ScreenPointerTest_InitRSUIContext_ScreenChanged_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    hwcmgr_ptr_t hwcmgr = std::make_shared<HardwareCursorPointerManager>();
    ASSERT_NE(hwcmgr, nullptr);
...
/**
 * @tc.name: ScreenPointerTest_InitRSUIContext_ScreenUnchanged_001
 * @tc.desc: Test InitRSUIContext when screen is unchanged and already initialized
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(ScreenPointerTest, ScreenPointerTest_InitRSUIContext_ScreenUnchanged_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    hwcmgr_ptr_t hwcmgr = std::make_shared<HardwareCursorPointerManager>();
    ASSERT_NE(hwcmgr, nullptr);
...
/**
 * @tc.name: ScreenPointerTest_MoveSoft_NullCheck_001
 * @tc.desc: Test MoveSoft with null surfaceNode
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(ScreenPointerTest, ScreenPointerTest_MoveSoft_NullCheck_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    hwcmgr_ptr_t hwcmgr = std::make_shared<HardwareCursorPointerManager>();
    ASSERT_NE(hwcmgr, nullptr);
...
/**
 * @tc.name: ScreenPointerTest_MoveSoft_NullCheck_002
 * @tc.desc: Test MoveSoft with null rsUIContext
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(ScreenPointerTest, ScreenPointerTest_MoveSoft_NullCheck_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    hwcmgr_ptr_t hwcmgr = std::make_shared<HardwareCursorPointerManager>();
    ASSERT_NE(hwcmgr, nullptr);
 ...
 *           sourceScreen is landscape(1920x1080) with no rotation, mirror screen is landscape(1920x1080)
 * @tc.type: Function
 * @tc.require:
 */
 ...
 *           sourceScreen is portrait(1080x1920), rotated 90 degrees, mirror screen is landscape(1920x1080)
 *           After swap: source(1920x1080), mirror(1920x1080), scale=1.0, padding=0
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(ScreenPointerTest, ScreenPointerTest_UpdatePadding_006, TestSize.Level1)
{
    ...
    bool ret = screenpointer->UpdatePadding(sourceScreenWidth, sourceScreenHeight);
    EXPECT_TRUE(ret);
    EXPECT_FLOAT_EQ(screenpointer->GetScale(), 1.0f);
    EXPECT_EQ(screenpointer->paddingTop_, 0u);
    EXPECT_EQ(screenpointer->paddingLeft_, 0u);
}
 ...
 *           sourceScreen is portrait(1080x1920), rotated 270 degrees, mirror screen is landscape(1920x1080)
 *           After swap: source(1920x1080), mirror(1920x1080), scale=1.0, padding=0
 * @tc.type: Function
 * @tc.require:
 */
 ...
 * @tc.desc: Test UpdatePadding with SCREEN_MIRROR mode and sourceScreenRotation_ ROTATION_0
 *           sourceScreen is landscape(1920x1080) with no rotation, mirror screen is landscape(1920x1080)
 *           No swap needed: source(1920x1080), mirror(1920x1080), scale=1.0, padding=0
 * @tc.type: Function
 * @tc.require:
 */
 ...
 *           sourceScreen is landscape(1920x1080) rotated 180 degrees, mirror screen is landscape(1920x1080)
 *           No swap for ROTATION_180: source(1920x1080), mirror(1920x1080), scale=1.0, padding=0
 * @tc.type: Function
 * @tc.require:
 */
 ...
 * @tc.desc: Test UpdatePadding with SCREEN_MIRROR mode, mirror screen rotation_ ROTATION_90
 *           but sourceScreenRotation_ ROTATION_0. Verify mirror screen's own rotation_ does not
 *           affect padding calculation. source(1920x1080), mirror(1920x1080), scale=1.0, padding=0
 * @tc.type: Function
 * @tc.require:
 */
