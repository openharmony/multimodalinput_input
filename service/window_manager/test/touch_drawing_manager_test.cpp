...
/**
 * @tc.name: TouchDrawingManagerTest_SetupSettingObserver_003
 * @tc.desc: Test SetupSettingObserver
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(TouchDrawingManagerTest, TouchDrawingManagerTest_SetupSettingObserver_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    TOUCH_DRAWING_MGR->hasBubbleObserver_ = true;
    TOUCH_DRAWING_MGR->hasPointerObserver_ = false;
