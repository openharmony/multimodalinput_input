...
/**
 	  * @tc.name: KeySubscriberHandlerTest_IsEnableCombineKey_008
 	  * @tc.desc: Test Is Enable CombineKey
 	  * @tc.type: FUNC
 	  * @tc.require:
 	  */
 	 HWTEST_F(KeySubscriberHandlerTest, KeySubscriberHandlerTest_IsEnableCombineKey_008, TestSize.Level1)
 	 {
 	     CALL_DEBUG_ENTER;
 	     KeySubscriberHandler handler;
 	     handler.enableCombineKey_ = false;
 	     ...
 	     item3.SetKeyCode(KeyEvent::KEYCODE_E);
 	     keyEvent->AddKeyItem(item3);
 	     
 	     bool result = handler.IsEnableCombineKey(keyEvent);
 	     EXPECT_TRUE(result);
 	 }
 	 
 	 /**
 	  * @tc.name: KeySubscriberHandlerTest_IsEnableCombineKey_009
 	  * @tc.desc: Test Is Enable CombineKey
 	  * @tc.type: FUNC
 	  * @tc.require:
 	  */
 	 HWTEST_F(KeySubscriberHandlerTest, KeySubscriberHandlerTest_IsEnableCombineKey_009, TestSize.Level1)
 	 {
 	     CALL_DEBUG_ENTER;
 	     KeySubscriberHandler handler;
 	     handler.enableCombineKey_ = false;
 	     ...
 	     KeyEvent::KeyItem item1;
 	     item1.SetKeyCode(KeyEvent::KEYCODE_L);
 	     keyEvent->AddKeyItem(item1);
 	 ...
 	 HWTEST_F(KeySubscriberHandlerTest, KeySubscriberHandlerTest_IsEnableCombineKeySwipe_002, TestSize.Level1)
 	 {
 	     ...
 	     KeyEvent::KeyItem item2;
 	     item2.SetKeyCode(KeyEvent::KEYCODE_META_LEFT);
 	     keyEvent->AddKeyItem(item2);
 	 
 	     KeyEvent::KeyItem item3;
 	     item3.SetKeyCode(KeyEvent::KEYCODE_DPAD_RIGHT);
 	     keyEvent->AddKeyItem(item3);
 	 
 	     bool result = handler.IsEnableCombineKeySwipe(keyEvent);
 	     EXPECT_TRUE(result);
 	 }
 	 ...
 	 HWTEST_F(KeySubscriberHandlerTest, KeySubscriberHandlerTest_IsEnableCombineKeySwipe_003, TestSize.Level1)
 	 {
 	     ...
 	     handler.EnableCombineKey(true);
 	     result = handler.IsEnableCombineKeySwipe(keyEvent);
 	     EXPECT_TRUE(result);
 	 }
 	 ...
 	 HWTEST_F(KeySubscriberHandlerTest, KeySubscriberHandlerTest_IsEnableCombineKeyRecord_003, TestSize.Level1)
 	 {
 	     ...
 	     KeyEvent::KeyItem item3;
 	     item3.SetKeyCode(KeyEvent::KEYCODE_R);
 	     keyEvent->AddKeyItem(item3);
 	     bool result = handler.IsEnableCombineKeyRecord(keyEvent);
 	     EXPECT_TRUE(result);
 	 }
 	 
 	 /**
 	  * @tc.name: KeySubscriberHandlerTest_IsEnableCombineKeyRecord_004
 	  * @tc.desc: Test is enable combine key record
 	  * @tc.type: FUNC
 	  * @tc.require:
 	  */
 	 HWTEST_F(KeySubscriberHandlerTest, KeySubscriberHandlerTest_IsEnableCombineKeyRecord_004, TestSize.Level1)
 	 {
 	     CALL_TEST_DEBUG;
 	     KeySubscriberHandler handler;
 	     std::shared_ptr<KeyEvent> keyEvent = KeyEvent::Create();
 	 ...
 	 /**
 	  * @tc.name: KeySubscriberHandlerTest_IsEnableCombineKeyRecord_005
 	  * @tc.desc: Test is enable combine key record
 	  * @tc.type: FUNC
 	  * @tc.require:
 	  */
 	 HWTEST_F(KeySubscriberHandlerTest, KeySubscriberHandlerTest_IsEnableCombineKeyRecord_005, TestSize.Level1)
 	 {
 	     CALL_TEST_DEBUG;
 	     KeySubscriberHandler handler;
 	     handler.EnableCombineKey(false);
 	     ...
 	     KeyEvent::KeyItem item1;
 	     item1.SetKeyCode(KeyEvent::KEYCODE_SHIFT_LEFT);
 	     keyEvent->AddKeyItem(item1);
 	 ...
 	 /**
 	  * @tc.name: KeySubscriberHandlerTest_IsEnableCombineKeyRecord_006
 	  * @tc.desc: Test is enable combine key record
 	  * @tc.type: FUNC
 	  * @tc.require:
 	  */
 	 HWTEST_F(KeySubscriberHandlerTest, KeySubscriberHandlerTest_IsEnableCombineKeyRecord_006, TestSize.Level1)
 	 {
 	     CALL_TEST_DEBUG;
 	     KeySubscriberHandler handler;
 	     handler.EnableCombineKey(true);
 	 ...
 	 HWTEST_F(KeySubscriberHandlerTest, KeySubscriberHandlerTest_InterceptByVm_003, TestSize.Level1)
 	 {
 	     ...
 	     KeyEvent::KeyItem item3;
 	     item3.SetKeyCode(KeyEvent::KEYCODE_SHIFT_LEFT);
 	     keyEvent->AddKeyItem(item3);
 	 
 	     bool result = handler.InterceptByVm(keyEvent);
 	     EXPECT_FALSE(result);
 	 }
 	 ...
 	 HWTEST_F(KeySubscriberHandlerTest, KeySubscriberHandlerTest_InterceptByVm_004, TestSize.Level1)
 	 {
 	     ...
 	     ASSERT_NE(keyEvent, nullptr);
 	     KeyEvent::KeyItem item1;
 	     item1.SetKeyCode(KeyEvent::KEYCODE_E);
 	     keyEvent->AddKeyItem(item1);
 	 ...
 	 /**
 	  * @tc.name: KeySubscriberHandlerTest_InterceptByVm_005
 	  * @tc.desc: Test InterceptByVm
 	  * @tc.type: FUNC
 	  * @tc.require:
 	  */
 	 HWTEST_F(KeySubscriberHandlerTest, KeySubscriberHandlerTest_InterceptByVm_005, TestSize.Level1)
 	 {
 	     CALL_TEST_DEBUG;
 	     KeySubscriberHandler handler;
 	     std::shared_ptr<KeyEvent> keyEvent = KeyEvent::Create();
