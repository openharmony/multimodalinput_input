...
/**
 * @tc.name: KnuckleHandlerComponentTest_Load
 * @tc.desc: Test Overrides Load function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_Load, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    ...
    KnuckleHandlerComponent::GetInstance().impl_ = knuckleHandler;
    KnuckleHandlerComponent::GetInstance().Load();
    KnuckleHandlerComponent::GetInstance().impl_ = nullptr;
    delete knuckleHandler;
    knuckleHandler = nullptr;

    KnuckleHandlerComponent::GetInstance().Load();
    ASSERT_NE(KnuckleHandlerComponent::GetInstance().impl_, nullptr);
    ASSERT_NE(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
    ASSERT_NE(KnuckleHandlerComponent::GetInstance().create_, nullptr);
    ASSERT_NE(KnuckleHandlerComponent::GetInstance().destroy_, nullptr);

    KnuckleHandlerComponent::GetInstance().Unload();
}

/**
 * @tc.name: KnuckleHandlerComponentTest_Unload
 * @tc.desc: Test Overrides Unload function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_Unload, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().impl_, nullptr);
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().create_, nullptr);
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().destroy_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_LoadKnuckleSharedLibrary
 * @tc.desc: Test Overrides LoadKnuckleSharedLibrary function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_LoadKnuckleSharedLibrary, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    bool ret = KnuckleHandlerComponent::GetInstance().LoadKnuckleSharedLibrary();
    ASSERT_TRUE(ret);
    ASSERT_NE(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
    ASSERT_NE(KnuckleHandlerComponent::GetInstance().create_, nullptr);
    ASSERT_NE(KnuckleHandlerComponent::GetInstance().destroy_, nullptr);
...
/**
 * @tc.name: KnuckleHandlerComponentTest_SetCurrentToolType_002
 * @tc.desc: Test Overrides LoadKnuckleSharedLibrary function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_SetCurrentToolType_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    KnuckleHandlerComponent::GetInstance().handle_ = ::dlopen(otherLib.c_str(), RTLD_LAZY);
    ASSERT_NE(KnuckleHandlerComponent::GetInstance().handle_, nullptr);

    struct TouchType touchType;
    int32_t toolType = PointerEvent::TOOL_TYPE_FINGER;
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().SetCurrentToolType(touchType, toolType));
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_NotifyTouchUp_002
 * @tc.desc: Test Overrides NotifyTouchUp function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_NotifyTouchUp_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().NotifyTouchUp(nullptr));
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_EnableFingersense_002
 * @tc.desc: Test Overrides EnableFingersense function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_EnableFingersense_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().EnableFingersense());
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_DisableFingersense_002
 * @tc.desc: Test Overrides DisableFingersense function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_DisableFingersense_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().DisableFingersense());
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_UpdateDisplayMode_002
 * @tc.desc: Test Overrides UpdateDisplayMode function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_UpdateDisplayMode_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().UpdateDisplayMode(0));
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_SaveTouchInfo_002
 * @tc.desc: Test Overrides SaveTouchInfo function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_SaveTouchInfo_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().SaveTouchInfo(0, 0, PointerEvent::TOOL_TYPE_FINGER));
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_CheckKnuckleEvent_002
 * @tc.desc: Test Overrides CheckKnuckleEvent function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_CheckKnuckleEvent_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    bool isKnuckleTypeParam = false;
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().CheckKnuckleEvent(0, 0, isKnuckleTypeParam));
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_SetMultiWindowScreenId_002
 * @tc.desc: Test Overrides SetMultiWindowScreenId function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_SetMultiWindowScreenId_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().SetMultiWindowScreenId(0, 0));
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_HandleKnuckleEvent_002
 * @tc.desc: Test Overrides HandleKnuckleEvent function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_HandleKnuckleEvent_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().HandleKnuckleEvent(nullptr));
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_RegisterSwitchObserver_002
 * @tc.desc: Test Overrides RegisterSwitchObserver function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_RegisterSwitchObserver_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().RegisterSwitchObserver());
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_RegisterKnuckleSwitchByUserId_002
 * @tc.desc: Test Overrides RegisterKnuckleSwitchByUserId function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_RegisterKnuckleSwitchByUserId_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().RegisterKnuckleSwitchByUserId(0));
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_SetKnucklePermissions_002
 * @tc.desc: Test Overrides SetKnucklePermissions function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_SetKnucklePermissions_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().SetKnucklePermissions(0, false));
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_SkipKnuckleDetect_002
 * @tc.desc: Test Overrides SkipKnuckleDetect function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_SkipKnuckleDetect_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().SkipKnuckleDetect());
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_SetKnuckleSwitch_002
 * @tc.desc: Test Overrides SetKnuckleSwitch function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_SetKnuckleSwitch_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().SetKnuckleSwitch(true));
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}

/**
 * @tc.name: KnuckleHandlerComponentTest_Dump_002
 * @tc.desc: Test Overrides Dump function branches
 * @tc.type: Function
 * @tc.require:
 */
HWTEST_F(KnuckleHandlerComponentTest, KnuckleHandlerComponentTest_Dump_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    KnuckleHandlerComponent::GetInstance().Unload();
    std::string otherLib = "libmmi_knuckle_drawing.z.so";
    ...
    ASSERT_NO_FATAL_FAILURE(KnuckleHandlerComponent::GetInstance().Dump(1));
    KnuckleHandlerComponent::GetInstance().Unload();
    ASSERT_EQ(KnuckleHandlerComponent::GetInstance().handle_, nullptr);
}
