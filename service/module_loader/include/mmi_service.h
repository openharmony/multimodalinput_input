...
public:
    ...
    int32_t SetTouchpadRotateSwitch(bool switchFlag) override;
    int32_t GetTouchpadRotateSwitch(bool &switchFlag) override;
...
protected:
    ...
    int32_t ReadTouchpadRotateSwitch(bool &switchFlag);
