...
/**
 * @tc.name: InfraredEmitterControllerTest_InitInfraredEmitter_006
 * @tc.desc: Test the funcation InitInfraredEmitter
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(InfraredEmitterControllerTest, InfraredEmitterControllerTest_InitInfraredEmitter_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    sptr<OHOS::HDI::Consumerir::V1_0::ConsumerIr> consumerIr = new ConsumerIrTest();
    EXPECT_CALL(*messageParcelMock_, Get(_, _))
...
/**
 * @tc.name: InfraredEmitterControllerTest_InitInfraredEmitter_007
 * @tc.desc: Test the funcation InitInfraredEmitter
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(InfraredEmitterControllerTest, InfraredEmitterControllerTest_InitInfraredEmitter_007, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    sptr<OHOS::HDI::Consumerir::V1_0::ConsumerIr> consumerIr = new ConsumerIrTest();
    EXPECT_CALL(*messageParcelMock_, Get(_, _))
...
/**
 * @tc.name: InfraredEmitterControllerTest_InitInfraredEmitter_008
 * @tc.desc: Test the funcation InitInfraredEmitter
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(InfraredEmitterControllerTest, InfraredEmitterControllerTest_InitInfraredEmitter_008, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    sptr<OHOS::HDI::Consumerir::V1_0::ConsumerIr> consumerIr = new ConsumerIrTest();
    EXPECT_CALL(*messageParcelMock_, Get(_, _))
...
/**
 * @tc.name: InfraredEmitterControllerTest_InitInfraredEmitter_009
 * @tc.desc: Test the funcation InitInfraredEmitter
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(InfraredEmitterControllerTest, InfraredEmitterControllerTest_InitInfraredEmitter_009, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    sptr<OHOS::HDI::Consumerir::V1_0::ConsumerIr> consumerIr = new ConsumerIrTest();
    EXPECT_CALL(*messageParcelMock_, Get(_, _))
