...
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_01, TestSize.Level1)
{
    ...
    bool result = servermsghandler.FixTargetWindowId(pointerEvent, action, false, PointerEvent::DISPLAY_COORDINATE);
    ASSERT_FALSE(result);
}
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdatePointerEvent_004
 * @tc.desc: Test the function UpdatePointerEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdatePointerEvent_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
    ...
    pointerEvent->AddPointerItem(item);
    pointerEvent->SetPointerId(0);
    handler.UpdatePointerEvent(pointerEvent);
...
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_001, TestSize.Level1)
{
    ...
    bool result = handler.FixTargetWindowId(pointerEvent, action, false, PointerEvent::DISPLAY_COORDINATE);
    ASSERT_FALSE(result);
}
...
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_006, TestSize.Level1)
{
    ...
    bool result = handler.FixTargetWindowId(pointerEvent, action, true, PointerEvent::DISPLAY_COORDINATE);
    ASSERT_FALSE(result);
    handler.shellTargetWindowIds_[touch] = 0;
    result = handler.FixTargetWindowId(pointerEvent, action, true, PointerEvent::DISPLAY_COORDINATE);
    ASSERT_FALSE(result);
...
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_007, TestSize.Level1)
{
    ...
    InjectionTouch touch{
        .displayId_ = pointerEvent->GetTargetDisplayId(), .pointerId_ = pointerEvent->GetPointerId()};
    handler.shellTargetWindowIds_[touch] = -1;
    int32_t result = handler.FixTargetWindowId(pointerEvent, action, true, PointerEvent::DISPLAY_COORDINATE);
    ASSERT_TRUE(result);
}
...
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_008, TestSize.Level1)
{
    ...
    handler.shellTargetWindowIds_[touch] = -1;
    pointerEvent->SetZOrder(1);
    ASSERT_NO_FATAL_FAILURE(handler.FixTargetWindowId(pointerEvent, action, true, PointerEvent::DISPLAY_COORDINATE));
...
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_009, TestSize.Level1)
{
    ...
    pointerEvent->SetDeviceId(CAST_INPUT_DEVICEID);
    pointerEvent->SetZOrder(-1);
    result = handler.FixTargetWindowId(pointerEvent, action, false, PointerEvent::DISPLAY_COORDINATE);
    ASSERT_FALSE(result);
    handler.shellTargetWindowIds_[touch] = 1;
...
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId01, TestSize.Level1)
{
    ...
    int32_t result = handler.FixTargetWindowId(pointerEvent, targetWindowIdMap, PointerEvent::DISPLAY_COORDINATE,
        bNeedResetPointerId, diffPointerId);
    EXPECT_EQ(result, RET_ERR);
}
...
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId02, TestSize.Level1)
{
    ...
    diffPointerId = 2;
    result = handler.FixTargetWindowId(pointerEvent, targetWindowIdMap, PointerEvent::DISPLAY_COORDINATE,
        bNeedResetPointerId, diffPointerId);
    EXPECT_EQ(result, RET_ERR);
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdateOthersTouchEvent_global
 * @tc.desc: Test the function UpdateOthersTouchEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateOthersTouchEvent_global, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    auto winMgr = std::static_pointer_cast<InputWindowsManager>(WIN_MGR);
    ASSERT_NE(winMgr, nullptr);
    OLD::DisplayGroupInfo displayGroupInfo;
    OLD::DisplayInfo displaysInfo = {.id = 0, .direction = Direction::DIRECTION0,
    ...
    winMgr->displayGroupInfoMap_[0] = displayGroupInfo;
    std::map<int32_t, WindowGroupInfo> windowGroups;
    WindowInfo window;
    window.id = 1;
    ...
    windowGroups[0] = windowGroupInfo;
    winMgr->windowsPerDisplayMap_[0] = windowGroups;
    ServerMsgHandler handler;
    std::shared_ptr<PointerEvent> pointerEvent = PointerEvent::Create();
    ASSERT_NE(pointerEvent, nullptr);
    PointerEvent::PointerItem item0;
    item0.SetPointerId(0);
    item0.SetGlobalX(800);
    item0.SetGlobalY(800);
    pointerEvent->AddPointerItem(item0);
    PointerEvent::PointerItem item1;
    item1.SetPointerId(1);
    item1.SetGlobalX(1000);
    item1.SetGlobalY(1500);
    pointerEvent->AddPointerItem(item1);
    pointerEvent->SetPointerId(0);
    InjectionTouch touch0{
        .displayId_ = 0, .pointerId_ = 1};
    InjectionTouch touch1{
        .displayId_ = 0, .pointerId_ = 1};
    std::map<InjectionTouch, int32_t> targetWindowIdMap;
    targetWindowIdMap[touch0] = 0;
    targetWindowIdMap[touch1] = 1;
    handler.UpdateOthersTouchEvent(pointerEvent, 0, targetWindowIdMap, PointerEvent::GLOBAL_COORDINATE);
    pointerEvent->GetPointerItem(1, item1);
    EXPECT_EQ(900, item1.GetDisplayX());
    EXPECT_EQ(1400, item1.GetDisplayY());
    EXPECT_EQ(1000, item1.GetWindowX());
    EXPECT_EQ(1500, item1.GetWindowY());
}

/**
 * @tc.name: ServerMsgHandlerTest_IsCastInject_001
 * @tc.desc: Test the function IsCastInject
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_IsCastInject_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    EXPECT_TRUE(handler.IsCastInject(CAST_INPUT_DEVICEID));
    EXPECT_TRUE(handler.IsCastInject(0xAAAAAAFE));
    EXPECT_FALSE(handler.IsCastInject(0));
    EXPECT_FALSE(handler.IsCastInject(-1));
    EXPECT_FALSE(handler.IsCastInject(100));
}

/**
 * @tc.name: ServerMsgHandlerTest_OnAuthorize_001
 * @tc.desc: Test the function OnAuthorize with isAuthorize true
 * @tc.type: FUNC
 * @tc.require:
 */
 ...
 * @tc.desc: Test the function OnAuthorize with isAuthorize false
 * @tc.type: FUNC
 * @tc.require:
 */
...
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnCancelInjection_001, TestSize.Level1)
{
    ...
    ServerMsgHandler handler;
    AUTHORIZE_HELPER->state_ = AuthorizeState::STATE_UNAUTHORIZE;
    int32_t callPid = 1234;
    int32_t result = handler.OnCancelInjection(callPid);
    EXPECT_EQ(result, ERR_OK);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnCancelInjection_002
 * @tc.desc: Test the function OnCancelInjection with STATE_AUTHORIZE
 * @tc.type: FUNC
 * @tc.require:
 */
...
/**
 * @tc.name: ServerMsgHandlerTest_OnCancelInjection_003
 * @tc.desc: Test the function OnCancelInjection with STATE_SELECTION_AUTHORIZE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnCancelInjection_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    AUTHORIZE_HELPER->state_ = AuthorizeState::STATE_SELECTION_AUTHORIZE;
...
/**
 * @tc.name: ServerMsgHandlerTest_IsPC_001
 * @tc.desc: Test the function IsPC
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_IsPC_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    bool result = handler.IsPC();
    EXPECT_FALSE(result);
}

/**
 * @tc.name: ServerMsgHandlerTest_GetRequestInjectionCallbackReqId_001
 * @tc.desc: Test the function GetRequestInjectionCallbackReqId
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_GetRequestInjectionCallbackReqId_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t reqId1 = handler.GetRequestInjectionCallbackReqId();
    int32_t reqId2 = handler.GetRequestInjectionCallbackReqId();
    EXPECT_NE(reqId1, reqId2);
    EXPECT_GT(reqId2, reqId1);
}

/**
 * @tc.name: ServerMsgHandlerTest_CheckForRequestInjectionFrequentAccess_001
 * @tc.desc: Test the function CheckForRequestInjectionFrequentAccess
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_CheckForRequestInjectionFrequentAccess_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t callingPid = 1234;
    int64_t interval = 3000;
    bool result = handler.CheckForRequestInjectionFrequentAccess(callingPid, interval);
    EXPECT_FALSE(result);
    result = handler.CheckForRequestInjectionFrequentAccess(callingPid, interval);
    EXPECT_TRUE(result);
}

/**
 * @tc.name: ServerMsgHandlerTest_CheckForRequestInjectionFrequentAccess_002
 * @tc.desc: Test the function CheckForRequestInjectionFrequentAccess with expired entry
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_CheckForRequestInjectionFrequentAccess_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t callingPid = 5678;
    int64_t interval = 0;
    bool result = handler.CheckForRequestInjectionFrequentAccess(callingPid, interval);
    EXPECT_FALSE(result);
    result = handler.CheckForRequestInjectionFrequentAccess(callingPid, interval);
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdateOtherTouchForDisplayCoordinate_001
 * @tc.desc: Test the function UpdateOtherTouchForDisplayCoordinate
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateOtherTouchForDisplayCoordinate_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    ...
    int32_t displayId = 0;
    bool result = handler.UpdateOtherTouchForDisplayCoordinate(pointerItem, displayId);
    EXPECT_TRUE(result);
}

/**
 * @tc.name: ServerMsgHandlerTest_UpdateOtherTouchForGlobalCoordinate_001
 * @tc.desc: Test the function UpdateOtherTouchForGlobalCoordinate with invalid coordinates
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateOtherTouchForGlobalCoordinate_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    PointerEvent::PointerItem pointerItem;
    ...
    bool result = handler.UpdateOtherTouchForGlobalCoordinate(pointerItem);
    EXPECT_FALSE(result);
}

/**
 * @tc.name: ServerMsgHandlerTest_UpdateOtherTouchForGlobalCoordinate_002
 * @tc.desc: Test the function UpdateOtherTouchForGlobalCoordinate with valid coordinates
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateOtherTouchForGlobalCoordinate_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    auto winMgr = std::static_pointer_cast<InputWindowsManager>(WIN_MGR);
    ASSERT_NE(winMgr, nullptr);
    ...
    ServerMsgHandler handler;
    PointerEvent::PointerItem pointerItem;
    pointerItem.SetGlobalX(100);
    pointerItem.SetGlobalY(100);
    bool result = handler.UpdateOtherTouchForGlobalCoordinate(pointerItem);
    EXPECT_TRUE(result);
}

/**
 * @tc.name: ServerMsgHandlerTest_UpdateOthersTouchEvent_001
 * @tc.desc: Test the function UpdateOthersTouchEvent with invalid useCoordinate
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateOthersTouchEvent_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
    ...
    std::map<InjectionTouch, int32_t> targetWindowIdMap;
    int32_t displayId = 0;
    int32_t useCoordinate = 999;
    ASSERT_NO_FATAL_FAILURE(handler.UpdateOthersTouchEvent(pointerEvent, displayId, targetWindowIdMap, useCoordinate));
}

/**
 * @tc.name: ServerMsgHandlerTest_OnInjectTouchPadEvent_001
 * @tc.desc: Test the function OnInjectTouchPadEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectTouchPadEvent_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    std::shared_ptr<PointerEvent> pointerEvent = nullptr;
    ...
    bool isNativeInject = true;
    bool isShell = false;
    int32_t result = handler.OnInjectTouchPadEvent(userId, pointerEvent, pid, touchpadCDG, isNativeInject, isShell);
    EXPECT_EQ(result, ERROR_NULL_POINTER);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnInjectTouchPadEvent_002
 * @tc.desc: Test the function OnInjectTouchPadEvent with valid pointerEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectTouchPadEvent_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
    ...
    pointerEvent->SetId(1);
    pointerEvent->SetSourceType(PointerEvent::SOURCE_TYPE_TOUCHPAD);
    handler.authorizationCollection_.insert(std::make_pair(pid, AuthorizationStatus::UNKNOWN));
    int32_t result = handler.OnInjectTouchPadEvent(userId, pointerEvent, pid, touchpadCDG, isNativeInject, isShell);
    EXPECT_EQ(result, COMMON_PERMISSION_CHECK_ERROR);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnInjectTouchPadEvent_003
 * @tc.desc: Test the function OnInjectTouchPadEvent with isNativeInject false
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectTouchPadEvent_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_AccelerateMotion_007
 * @tc.desc: Test the function AccelerateMotion with PULL_MOVE action
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_AccelerateMotion_007, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_AccelerateMotion_009
 * @tc.desc: Test the function AccelerateMotion with BUTTON_DOWN action
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_AccelerateMotion_009, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_AccelerateMotion_010
 * @tc.desc: Test the function AccelerateMotion with TOUCHPAD_POINTER and VIRTUAL_TOUCHPAD_POINTER flags
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_AccelerateMotion_010, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
    ...
    pointerEvent->AddFlag(InputEvent::EVENT_FLAG_RAW_POINTER_MOVEMENT);
    pointerEvent->AddFlag(InputEvent::EVENT_FLAG_TOUCHPAD_POINTER);
    pointerEvent->AddFlag(InputEvent::EVENT_FLAG_VIRTUAL_TOUCHPAD_POINTER);
    pointerEvent->SetSourceType(PointerEvent::SOURCE_TYPE_MOUSE);
    pointerEvent->SetPointerAction(PointerEvent::POINTER_ACTION_MOVE);
    int32_t pointerId = 0;
    PointerEvent::PointerItem item;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnInjectKeyEvent_008
 * @tc.desc: Test the function OnInjectKeyEvent with null keyEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectKeyEvent_008, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    ...
    int32_t pid = 1234;
    bool isNativeInject = true;
    int32_t result = handler.OnInjectKeyEvent(keyEvent, pid, isNativeInject);
    EXPECT_EQ(result, ERROR_NULL_POINTER);
}

/**
 * @tc.name: ServerMsgHandlerTest_SaveTargetWindowId_009
 * @tc.desc: Test the function SaveTargetWindowId with null pointerEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_SaveTargetWindowId_009, TestSize.Level1)
{
    ...
    ServerMsgHandler handler;
    std::shared_ptr<PointerEvent> pointerEvent = nullptr;
    int32_t result = handler.SaveTargetWindowId(pointerEvent, false);
    EXPECT_EQ(result, ERROR_NULL_POINTER);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnInjectPointerEventExt_003
 * @tc.desc: Test the function OnInjectPointerEventExt with null pointerEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectPointerEventExt_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    std::shared_ptr<PointerEvent> pointerEvent = nullptr;
    int32_t userId = 100;
    int32_t result = handler.OnInjectPointerEventExt(userId, pointerEvent, false, PointerEvent::DISPLAY_COORDINATE);
    EXPECT_EQ(result, ERROR_NULL_POINTER);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnInjectTouchPadEventExt_001
 * @tc.desc: Test the function OnInjectTouchPadEventExt with null pointerEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectTouchPadEventExt_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    std::shared_ptr<PointerEvent> pointerEvent = nullptr;
    TouchpadCDG touchpadCDG;
    int32_t result = handler.OnInjectTouchPadEventExt(100, pointerEvent, touchpadCDG, false);
    EXPECT_EQ(result, ERROR_NULL_POINTER);
}

/**
 * @tc.name: ServerMsgHandlerTest_AccelerateMotionTouchpad_002
 * @tc.desc: Test the function AccelerateMotionTouchpad with valid pointerEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_AccelerateMotionTouchpad_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
    ...
    pointerEvent->SetPointerId(0);
    TouchpadCDG touchpadCDG;
    touchpadCDG.size = 100;
    touchpadCDG.ppi = 100;
    touchpadCDG.speed = 5;
    touchpadCDG.frequency = 60;
    int32_t userId = 100;
    int32_t ret = handler.AccelerateMotionTouchpad(userId, pointerEvent, touchpadCDG);
    EXPECT_EQ(ret, RET_ERR);
}
...
/**
 * @tc.name: ServerMsgHandlerTest_CalculateOffset_002
 * @tc.desc: Test the function CalculateOffset with all directions
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_CalculateOffset_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    Offset offset;
    ...
    ASSERT_NO_FATAL_FAILURE(handler.CalculateOffset(direction, offset));
    EXPECT_EQ(offset.dx, 100.0);
    EXPECT_EQ(offset.dy, 50.0);
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdatePointerEvent_005
 * @tc.desc: Test the function UpdatePointerEvent with TOUCHPAD_ACTIVE action
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdatePointerEvent_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_FixTargetWindowId_010
 * @tc.desc: Test the function FixTargetWindowId with bNeedResetPointerId true and diffPointerId valid
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_010, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_OnUiExtentionWindowInfo_002
 * @tc.desc: Test the function OnUiExtentionWindowInfo with zero num
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnUiExtentionWindowInfo_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    NetPacket pkt(MmiMessageId::ADD_INPUT_DEVICE_LISTENER);
...
/**
 * @tc.name: ServerMsgHandlerTest_OnUiExtentionWindowInfo_003
 * @tc.desc: Test the function OnUiExtentionWindowInfo with MAX size
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnUiExtentionWindowInfo_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    NetPacket pkt(MmiMessageId::ADD_INPUT_DEVICE_LISTENER);
    WindowInfo info;
    uint32_t num = MAX_UI_EXTENSION_SIZE + 1;
    pkt << num;
    int32_t ret = handler.OnUiExtentionWindowInfo(pkt, info);
    EXPECT_EQ(ret, RET_ERR);
}
...
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_RequestInjection_001, TestSize.Level1)
{
    ...
    int32_t reqId = 0;
    AUTHORIZE_HELPER->state_ = AuthorizeState::STATE_AUTHORIZE;
    int32_t result = handler.RequestInjection(callingPid, status, reqId);
    EXPECT_EQ(result, ERROR_DEVICE_NOT_SUPPORTED);
}

/**
 * @tc.name: ServerMsgHandlerTest_QueryAuthorizedStatus_002
 * @tc.desc: Test the function QueryAuthorizedStatus with different states
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_QueryAuthorizedStatus_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t callingPid = 1234;
    ...
    EXPECT_EQ(result, ERR_OK);
    AUTHORIZE_HELPER->state_ = AuthorizeState::STATE_SELECTION_AUTHORIZE;
    result = handler.QueryAuthorizedStatus(callingPid, status);
    EXPECT_EQ(result, ERR_OK);
}

/**
 * @tc.name: ServerMsgHandlerTest_NativeInjectCheck_004
 * @tc.desc: Test the function NativeInjectCheck with STATE_SELECTION_AUTHORIZE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_NativeInjectCheck_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t pid = 1234;
    AUTHORIZE_HELPER->state_ = AuthorizeState::STATE_SELECTION_AUTHORIZE;
    int32_t result = handler.NativeInjectCheck(pid);
    EXPECT_EQ(result, COMMON_PERMISSION_CHECK_ERROR);
}

/**
 * @tc.name: ServerMsgHandlerTest_NativeInjectCheck_005
 * @tc.desc: Test the function NativeInjectCheck with STATE_AUTHORIZE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_NativeInjectCheck_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t pid = 1234;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnDisplayInfo_010
 * @tc.desc: Test the function OnDisplayInfo with null session
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnDisplayInfo_010, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    SessionPtr sess = nullptr;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnWindowGroupInfo_006
 * @tc.desc: Test the function OnWindowGroupInfo with null session
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnWindowGroupInfo_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    SessionPtr sess = nullptr;
    NetPacket pkt(MmiMessageId::INVALID);
    int32_t result = handler.OnWindowGroupInfo(sess, pkt);
    EXPECT_EQ(result, ERROR_NULL_POINTER);
}

/**
 * @tc.name: ServerMsgHandlerTest_RegisterWindowStateErrorCallback_002
 * @tc.desc: Test the function RegisterWindowStateErrorCallback with non-sceneboard program
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_RegisterWindowStateErrorCallback_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    MmiMessageId idMsg = MmiMessageId::ADD_INPUT_DEVICE_LISTENER;
    NetPacket pkt(idMsg);
    SessionPtr sess = std::make_shared<UDSSession>(PROGRAM_NAME, g_moduleType, g_writeFd, UID_ROOT, g_pid);
    sess->programName_ = "other.program";
    int32_t ret = handler.RegisterWindowStateErrorCallback(sess, pkt);
    EXPECT_EQ(ret, RET_ERR);
}

/**
 * @tc.name: ServerMsgHandlerTest_ReadDisplaysInfo_003
 * @tc.desc: Test the function ReadDisplaysInfo with read error
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ReadDisplaysInfo_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    DisplayGroupInfo displayGroupInfo;
    ...
    uint32_t num = 1;
    pkt << num;
    int32_t ret = handler.ReadDisplaysInfo(pkt, displayGroupInfo);
    EXPECT_EQ(ret, RET_ERR);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnAddGestureMonitor_002
 * @tc.desc: Test the function OnAddGestureMonitor with NONE handler type
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnAddGestureMonitor_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto udsSe = std::make_shared<UDSSession>("mytest", 2, 3, 4, 5);
...
/**
 * @tc.name: ServerMsgHandlerTest_OnRemoveGestureMonitor_002
 * @tc.desc: Test the function OnRemoveGestureMonitor with NONE handler type
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnRemoveGestureMonitor_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto udsSe = std::make_shared<UDSSession>("mytest", 2, 3, 4, 5);
    ...
    uint32_t gestureType = TOUCH_GESTURE_TYPE_PINCH;
    uint32_t fingers = 3;
    int32_t ret = handler.OnRemoveGestureMonitor(udsSe, handlerType, eventType, gestureType, fingers);
    EXPECT_EQ(ret, RET_OK);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnRemoveGestureMonitor_003
 * @tc.desc: Test the function OnRemoveGestureMonitor with null session
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnRemoveGestureMonitor_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    SessionPtr sess = nullptr;
    ...
    uint32_t gestureType = TOUCH_GESTURE_TYPE_PINCH;
    uint32_t fingers = 3;
    int32_t ret = handler.OnRemoveGestureMonitor(sess, handlerType, eventType, gestureType, fingers);
    EXPECT_NE(ret, RET_OK);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnMarkConsumed_003
 * @tc.desc: Test the function OnMarkConsumed with null session
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnMarkConsumed_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    SessionPtr sess = nullptr;
    int32_t eventId = 100;
    int32_t ret = handler.OnMarkConsumed(sess, eventId);
    EXPECT_EQ(ret, ERROR_NULL_POINTER);
}

/**
 * @tc.name: ServerMsgHandlerTest_ScreenFactor_002
 * @tc.desc: Test the function ScreenFactor with boundary values
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ScreenFactor_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    EXPECT_EQ(handler.ScreenFactor(-1), FACTOR_0);
    EXPECT_EQ(handler.ScreenFactor(0), FACTOR_0);
    EXPECT_EQ(handler.ScreenFactor(7), FACTOR_8);
    EXPECT_EQ(handler.ScreenFactor(8), FACTOR_18);
    EXPECT_EQ(handler.ScreenFactor(17), FACTOR_18);
    EXPECT_EQ(handler.ScreenFactor(18), FACTOR_27);
    EXPECT_EQ(handler.ScreenFactor(26), FACTOR_27);
    EXPECT_EQ(handler.ScreenFactor(27), FACTOR_55);
    EXPECT_EQ(handler.ScreenFactor(54), FACTOR_55);
    EXPECT_EQ(handler.ScreenFactor(55), FACTOR_MAX);
    EXPECT_EQ(handler.ScreenFactor(100), FACTOR_MAX);
}
 ...
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_DealGesturePointers_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_FixTargetWindowId_011
 * @tc.desc: Test the function FixTargetWindowId with different conditions
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_011, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
 ...
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_012, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_FixTargetWindowId_013
 * @tc.desc: Test the function FixTargetWindowId with native target window
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_013, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_SaveTargetWindowId_010
 * @tc.desc: Test the function SaveTargetWindowId with cast inject and zOrder > 0
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_SaveTargetWindowId_010, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
 ...
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_SaveTargetWindowId_011, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_SaveTargetWindowId_012
 * @tc.desc: Test the function SaveTargetWindowId with HOVER_EXIT action
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_SaveTargetWindowId_012, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
 ...
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_SaveTargetWindowId_013, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdateTouchEvent_005
 * @tc.desc: Test the function UpdateTouchEvent with empty pointerIds
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateTouchEvent_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdateTouchEvent_006
 * @tc.desc: Test the function UpdateTouchEvent with valid pointerIds
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateTouchEvent_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_OnSetFunctionKeyState_004
 * @tc.desc: Test the function OnSetFunctionKeyState with checkState equal to enable
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnSetFunctionKeyState_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t funcKey = CAPS_LOCK_FUNCTION_KEY;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnGetFunctionKeyState_004
 * @tc.desc: Test the function OnGetFunctionKeyState
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnGetFunctionKeyState_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t funcKey = SCROLL_LOCK_FUNCTION_KEY;
    bool state = false;
    int32_t ret = handler.OnGetFunctionKeyState(funcKey, state);
    EXPECT_EQ(ret, ERR_DEVICE_NOT_EXIST);
}
...
/**
 * @tc.name: ServerMsgHandlerTest_OnMsgHandler_005
 * @tc.desc: Test the function OnMsgHandler with null session
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnMsgHandler_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler msgHandler;
    SessionPtr sess = nullptr;
    MmiMessageId idMsg = MmiMessageId::INVALID;
    NetPacket pkt(idMsg);
    ASSERT_NO_FATAL_FAILURE(msgHandler.OnMsgHandler(sess, pkt));
}

/**
 * @tc.name: ServerMsgHandlerTest_OnInjectPointerEvent_006
 * @tc.desc: Test the function OnInjectPointerEvent with null pointerEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectPointerEvent_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler msgHandler;
    std::shared_ptr<PointerEvent> pointerEvent = nullptr;
...
/**
 * @tc.name: ServerMsgHandlerTest_AccelerateMotion_011
 * @tc.desc: Test the function AccelerateMotion with non-mouse source type
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_AccelerateMotion_011, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_OnEnhanceConfig_005
 * @tc.desc: Test the function OnEnhanceConfig with ACCESS_TOKEN_SERVICE_ID
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnEnhanceConfig_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    MmiMessageId idMsg = MmiMessageId::ADD_INPUT_DEVICE_LISTENER;
    ...
    pkt.rwErrorStatus_ = CircleStreamBuffer::ErrorStatus::ERROR_STATUS_OK;
    pkt << 1 << 1;
    SessionPtr sess = std::make_shared<UDSSession>(PROGRAM_NAME, g_moduleType, g_writeFd, 3020, g_pid);
    int32_t ret = handler.OnEnhanceConfig(sess, pkt);
    EXPECT_EQ(ret, RET_ERR);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnEnhanceConfig_006
 * @tc.desc: Test the function OnEnhanceConfig with null session
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnEnhanceConfig_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    SessionPtr sess = nullptr;
...
/**
 * @tc.name: ServerMsgHandlerTest_ReadWindowsInfo_004
 * @tc.desc: Test the function ReadWindowsInfo with valid data
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ReadWindowsInfo_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    DisplayGroupInfo displayGroupInfo;
    ...
    uint32_t num = 0;
    pkt << num;
    int32_t ret = handler.ReadWindowsInfo(pkt, displayGroupInfo, oldDisplayGroupInfo);
    EXPECT_EQ(ret, RET_OK);
}

/**
 * @tc.name: ServerMsgHandlerTest_ChangeToOld_008
 * @tc.desc: Test the function ChangeToOld with empty displayGroups
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ChangeToOld_008, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    UserScreenInfo userScreenInfo;
    userScreenInfo.userId = 0;
    userScreenInfo.displayGroups.clear();
    handler.oldDisplayGroupInfos_.clear();
    EXPECT_TRUE(handler.ChangeToOld(userScreenInfo));
}

/**
 * @tc.name: ServerMsgHandlerTest_ChangeToOld_009
 * @tc.desc: Test the function ChangeToOld with matching sizes
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ChangeToOld_009, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    UserScreenInfo userScreenInfo;
    ...
    group.id = 0;
    group.type = GroupType::GROUP_DEFAULT;
    group.mainDisplayId = 0;
    group.focusWindowId = GLOBAL_WINDOW_ID;
    userScreenInfo.displayGroups.push_back(group);
    OLD::DisplayGroupInfo oldInfo;
    handler.oldDisplayGroupInfos_.push_back(oldInfo);
    EXPECT_TRUE(handler.ChangeToOld(userScreenInfo));
...
/**
 * @tc.name: ServerMsgHandlerTest_Printf_002
 * @tc.desc: Test the function Printf with empty data
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_Printf_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    UserScreenInfo userScreenInfo;
...
/**
 * @tc.name: ServerMsgHandlerTest_ChangeToOld_010
 * @tc.desc: Test the function ChangeToOld with DIRECTION180
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ChangeToOld_010, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    size_t num = 0;
    std::vector<DisplayInfo> displaysInfos;
...
/**
 * @tc.name: ServerMsgHandlerTest_ChangeToOld_011
 * @tc.desc: Test the function ChangeToOld with DIRECTION270
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ChangeToOld_011, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    size_t num = 0;
    std::vector<DisplayInfo> displaysInfos;
...
/**
 * @tc.name: ServerMsgHandlerTest_ChangeToOld_012
 * @tc.desc: Test the function ChangeToOld with no matching screen
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ChangeToOld_012, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    size_t num = 0;
    std::vector<DisplayInfo> displaysInfos;
...
/**
 * @tc.name: ServerMsgHandlerTest_Init_002
 * @tc.desc: Test the function Init
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_Init_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    UDSServer udsServer;
    ASSERT_NO_FATAL_FAILURE(handler.Init(udsServer));
}

/**
 * @tc.name: ServerMsgHandlerTest_SetWindowInfo_002
 * @tc.desc: Test the function SetWindowInfo with invalid infoId
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_SetWindowInfo_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t infoId = 999;
    WindowInfo info;
    handler.transparentWins_.clear();
    ASSERT_NO_FATAL_FAILURE(handler.SetWindowInfo(infoId, info));
}

/**
 * @tc.name: ServerMsgHandlerTest_OnCancelInjection_004
 * @tc.desc: Test the function OnCancelInjection with matching pid
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnCancelInjection_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    AUTHORIZE_HELPER->state_ = AuthorizeState::STATE_AUTHORIZE;
 ...
 * @tc.desc: Test the function OnCancelInjection with STATE_SELECTION_AUTHORIZE and matching pid
 * @tc.type: FUNC
 * @tc.require:
 */
...
/**
 * @tc.name: ServerMsgHandlerTest_QueryAuthorizedStatus_003
 * @tc.desc: Test the function QueryAuthorizedStatus with same pid and STATE_AUTHORIZE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_QueryAuthorizedStatus_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t callingPid = 1234;
...
/**
 * @tc.name: ServerMsgHandlerTest_QueryAuthorizedStatus_004
 * @tc.desc: Test the function QueryAuthorizedStatus with different pid and STATE_AUTHORIZE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_QueryAuthorizedStatus_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t callingPid = 5678;
...
/**
 * @tc.name: ServerMsgHandlerTest_QueryAuthorizedStatus_005
 * @tc.desc: Test the function QueryAuthorizedStatus with same pid and STATE_SELECTION_AUTHORIZE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_QueryAuthorizedStatus_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t callingPid = 1234;
...
/**
 * @tc.name: ServerMsgHandlerTest_QueryAuthorizedStatus_006
 * @tc.desc: Test the function QueryAuthorizedStatus with different pid and STATE_SELECTION_AUTHORIZE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_QueryAuthorizedStatus_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t callingPid = 5678;
...
/**
 * @tc.name: ServerMsgHandlerTest_NativeInjectCheck_006
 * @tc.desc: Test the function NativeInjectCheck with same pid and STATE_AUTHORIZE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_NativeInjectCheck_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t pid = 1234;
...
/**
 * @tc.name: ServerMsgHandlerTest_NativeInjectCheck_007
 * @tc.desc: Test the function NativeInjectCheck with different pid and STATE_SELECTION_AUTHORIZE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_NativeInjectCheck_007, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t pid = 5678;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnInjectPointerEvent_007
 * @tc.desc: Test the function OnInjectPointerEvent with isNativeInject false
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectPointerEvent_007, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler msgHandler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_OnInjectKeyEvent_009
 * @tc.desc: Test the function OnInjectKeyEvent with isNativeInject false and valid keyEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectKeyEvent_009, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnInjectTouchPadEvent_004
 * @tc.desc: Test the function OnInjectTouchPadEvent with isShell true
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectTouchPadEvent_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_OnInjectTouchPadEventExt_002
 * @tc.desc: Test the function OnInjectTouchPadEventExt with SOURCE_TYPE_MOUSE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectTouchPadEventExt_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
    ...
    TouchpadCDG touchpadCDG;
    int32_t userId = 100;
    int32_t result = handler.OnInjectTouchPadEventExt(userId, pointerEvent, touchpadCDG, false);
    EXPECT_NE(result, RET_OK);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnInjectTouchPadEventExt_003
 * @tc.desc: Test the function OnInjectTouchPadEventExt with non-mouse source type
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectTouchPadEventExt_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_AccelerateMotion_012
 * @tc.desc: Test the function AccelerateMotion with non-RAW_POINTER_MOVEMENT flag
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_AccelerateMotion_012, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_AccelerateMotion_013
 * @tc.desc: Test the function AccelerateMotion with non-MOVE action
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_AccelerateMotion_013, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_AccelerateMotion_014
 * @tc.desc: Test the function AccelerateMotion with TOUCHPAD_POINTER flag only
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_AccelerateMotion_014, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_AccelerateMotionTouchpad_003
 * @tc.desc: Test the function AccelerateMotionTouchpad with invalid pointerItem
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_AccelerateMotionTouchpad_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdatePointerEvent_006
 * @tc.desc: Test the function UpdatePointerEvent without RAW_POINTER_MOVEMENT flag
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdatePointerEvent_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdatePointerEvent_007
 * @tc.desc: Test the function UpdatePointerEvent with TOUCHPAD source type
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdatePointerEvent_007, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_SaveTargetWindowId_014
 * @tc.desc: Test the function SaveTargetWindowId with non-TOUCHSCREEN source type
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_SaveTargetWindowId_014, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_SaveTargetWindowId_015
 * @tc.desc: Test the function SaveTargetWindowId with cast inject and zOrder <= 0
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_SaveTargetWindowId_015, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_SaveTargetWindowId_016
 * @tc.desc: Test the function SaveTargetWindowId with UP action and cast inject
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_SaveTargetWindowId_016, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
 ...
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_SaveTargetWindowId_017, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_FixTargetWindowId_014
 * @tc.desc: Test the function FixTargetWindowId with shell target
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_014, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_FixTargetWindowId_015
 * @tc.desc: Test the function FixTargetWindowId with cast target and zOrder <= 0
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_015, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_FixTargetWindowId_016
 * @tc.desc: Test the function FixTargetWindowId with negative diffPointerId
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_016, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_FixTargetWindowId_017
 * @tc.desc: Test the function FixTargetWindowId with bNeedResetPointerId false
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_FixTargetWindowId_017, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdateTouchEvent_007
 * @tc.desc: Test the function UpdateTouchEvent with HOVER_ENTER action
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateTouchEvent_007, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdateTouchEvent_008
 * @tc.desc: Test the function UpdateTouchEvent with DOWN action
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateTouchEvent_008, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdateTouchEvent_009
 * @tc.desc: Test the function UpdateTouchEvent with negative targetWindowId
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateTouchEvent_009, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_OnSetFunctionKeyState_005
 * @tc.desc: Test the function OnSetFunctionKeyState with SCROLL_LOCK
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnSetFunctionKeyState_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t funcKey = SCROLL_LOCK_FUNCTION_KEY;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnGetFunctionKeyState_005
 * @tc.desc: Test the function OnGetFunctionKeyState with NUM_LOCK
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnGetFunctionKeyState_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t funcKey = NUM_LOCK_FUNCTION_KEY;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnMsgHandler_006
 * @tc.desc: Test the function OnMsgHandler with valid callback
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnMsgHandler_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler msgHandler;
    UDSServer udsServer;
    msgHandler.Init(udsServer);
    SessionPtr sess = std::make_shared<UDSSession>(PROGRAM_NAME, g_moduleType, g_writeFd, UID_ROOT, g_pid);
    NetPacket pkt(MmiMessageId::DISPLAY_INFO);
    ASSERT_NO_FATAL_FAILURE(msgHandler.OnMsgHandler(sess, pkt));
}
...
/**
 * @tc.name: ServerMsgHandlerTest_OnMsgHandler_007
 * @tc.desc: Test the function OnMsgHandler with WINDOW_INFO message
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnMsgHandler_007, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler msgHandler;
    UDSServer udsServer;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnInjectPointerEventExt_004
 * @tc.desc: Test the function OnInjectPointerEventExt with SOURCE_TYPE_JOYSTICK
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectPointerEventExt_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_OnInjectPointerEventExt_005
 * @tc.desc: Test the function OnInjectPointerEventExt with SOURCE_TYPE_TOUCHPAD
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectPointerEventExt_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_OnInjectPointerEventExt_006
 * @tc.desc: Test the function OnInjectPointerEventExt with unknown source type
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnInjectPointerEventExt_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_OnEnhanceConfig_007
 * @tc.desc: Test the function OnEnhanceConfig with invalid uid
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnEnhanceConfig_007, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    MmiMessageId idMsg = MmiMessageId::ADD_INPUT_DEVICE_LISTENER;
    ...
    pkt.rwErrorStatus_ = CircleStreamBuffer::ErrorStatus::ERROR_STATUS_OK;
    pkt << 1 << 1;
    SessionPtr sess = std::make_shared<UDSSession>(PROGRAM_NAME, g_moduleType, g_writeFd, 9999, g_pid);
    int32_t ret = handler.OnEnhanceConfig(sess, pkt);
    EXPECT_EQ(ret, RET_ERR);
}

/**
 * @tc.name: ServerMsgHandlerTest_ReadScreensInfo_004
 * @tc.desc: Test the function ReadScreensInfo with valid data
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ReadScreensInfo_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    UserScreenInfo userScreenInfo;
    ...
    uint32_t num = 0;
    pkt << num;
    int32_t ret = handler.ReadScreensInfo(pkt, userScreenInfo);
    EXPECT_EQ(ret, RET_OK);
}

/**
 * @tc.name: ServerMsgHandlerTest_ReadDisplayGroupsInfo_004
 * @tc.desc: Test the function ReadDisplayGroupsInfo with valid data
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ReadDisplayGroupsInfo_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    UserScreenInfo userScreenInfo;
    ...
    uint32_t num = 0;
    pkt << num;
    int32_t ret = handler.ReadDisplayGroupsInfo(pkt, userScreenInfo);
    EXPECT_EQ(ret, RET_OK);
}

/**
 * @tc.name: ServerMsgHandlerTest_ReadDisplaysInfo_004
 * @tc.desc: Test the function ReadDisplaysInfo with valid data
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ReadDisplaysInfo_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    DisplayGroupInfo displayGroupInfo;
...
/**
 * @tc.name: ServerMsgHandlerTest_ChangeToOld_013
 * @tc.desc: Test the function ChangeToOld with valid num
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ChangeToOld_013, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    size_t num = 0;
    std::vector<DisplayInfo> displaysInfos;
...
/**
 * @tc.name: ServerMsgHandlerTest_ChangeToOld_014
 * @tc.desc: Test the function ChangeToOld with num >= oldDisplayGroupInfos_.size()
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_ChangeToOld_014, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    size_t num = 10;
    std::vector<DisplayInfo> displaysInfos;
...
/**
 * @tc.name: ServerMsgHandlerTest_Printf_003
 * @tc.desc: Test the function Printf with screens data
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_Printf_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    UserScreenInfo userScreenInfo;
...
/**
 * @tc.name: ServerMsgHandlerTest_Printf_004
 * @tc.desc: Test the function Printf with displayGroups data
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_Printf_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    UserScreenInfo userScreenInfo;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnDisplayInfo_011
 * @tc.desc: Test the function OnDisplayInfo with TOKEN_SHELL
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnDisplayInfo_011, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    SessionPtr sess = std::make_shared<UDSSession>(PROGRAM_NAME, g_moduleType, g_writeFd, UID_ROOT, g_pid);
    sess->SetTokenType(TokenType::TOKEN_SHELL);
    NetPacket pkt(MmiMessageId::DISPLAY_INFO);
    int32_t userId = 0;
    uint32_t screenNum = 0;
    uint32_t groupNum = 0;
    pkt << userId << screenNum << groupNum;
    int32_t result = handler.OnDisplayInfo(sess, pkt);
    EXPECT_EQ(result, RET_OK);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnDisplayInfo_012
 * @tc.desc: Test the function OnDisplayInfo with TOKEN_SYSTEM_HAP
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnDisplayInfo_012, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    SessionPtr sess = std::make_shared<UDSSession>(PROGRAM_NAME, g_moduleType, g_writeFd, UID_ROOT, g_pid);
    sess->SetTokenType(TokenType::TOKEN_SYSTEM_HAP);
    NetPacket pkt(MmiMessageId::DISPLAY_INFO);
    int32_t userId = 0;
    uint32_t screenNum = 0;
    uint32_t groupNum = 0;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnWindowGroupInfo_007
 * @tc.desc: Test the function OnWindowGroupInfo with TOKEN_SHELL
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnWindowGroupInfo_007, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    SessionPtr sess = std::make_shared<UDSSession>(PROGRAM_NAME, g_moduleType, g_writeFd, UID_ROOT, g_pid);
    ...
    int32_t displayId = 0;
    uint32_t num = 0;
    pkt << focusWindowId << displayId << num;
    int32_t result = handler.OnWindowGroupInfo(sess, pkt);
    EXPECT_EQ(result, RET_OK);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnWindowGroupInfo_008
 * @tc.desc: Test the function OnWindowGroupInfo with TOKEN_SYSTEM_HAP
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnWindowGroupInfo_008, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    SessionPtr sess = std::make_shared<UDSSession>(PROGRAM_NAME, g_moduleType, g_writeFd, UID_ROOT, g_pid);
...
/**
 * @tc.name: ServerMsgHandlerTest_RegisterWindowStateErrorCallback_003
 * @tc.desc: Test the function RegisterWindowStateErrorCallback with valid program name
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_RegisterWindowStateErrorCallback_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    MmiMessageId idMsg = MmiMessageId::ADD_INPUT_DEVICE_LISTENER;
...
/**
 * @tc.name: ServerMsgHandlerTest_OnAddGestureMonitor_003
 * @tc.desc: Test the function OnAddGestureMonitor with different gesture types
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnAddGestureMonitor_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto udsSe = std::make_shared<UDSSession>("mytest", 2, 3, 4, 5);
    InputHandlerType handlerType = InputHandlerType::MONITOR;
    uint32_t eventType = HANDLE_EVENT_TYPE_TOUCH;
    uint32_t gestureType = TOUCH_GESTURE_TYPE_SWIPE;
    uint32_t fingers = 3;
    InputHandler->eventMonitorHandler_ = std::make_shared<EventMonitorHandler>();
    int32_t ret = handler.OnAddGestureMonitor(udsSe, handlerType, eventType, gestureType, fingers);
    ASSERT_NE(ret, RET_OK);
...
/**
 * @tc.name: ServerMsgHandlerTest_OnRemoveGestureMonitor_004
 * @tc.desc: Test the function OnRemoveGestureMonitor with different gesture types
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnRemoveGestureMonitor_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto udsSe = std::make_shared<UDSSession>("mytest", 2, 3, 4, 5);
...
/**
 * @tc.name: ServerMsgHandlerTest_DealGesturePointers_004
 * @tc.desc: Test the function DealGesturePointers with multiple pointer items
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_DealGesturePointers_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdateOthersTouchEvent_002
 * @tc.desc: Test the function UpdateOthersTouchEvent with DISPLAY_COORDINATE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateOthersTouchEvent_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdateOthersTouchEvent_003
 * @tc.desc: Test the function UpdateOthersTouchEvent with GLOBAL_COORDINATE
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateOthersTouchEvent_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    auto pointerEvent = PointerEvent::Create();
    ...
    PointerEvent::PointerItem item1;
    item1.SetPointerId(1);
    item1.SetGlobalX(100);
    item1.SetGlobalY(100);
    pointerEvent->AddPointerItem(item1);
    pointerEvent->SetPointerId(0);
    std::map<InjectionTouch, int32_t> targetWindowIdMap;
    int32_t displayId = 0;
    int32_t useCoordinate = PointerEvent::GLOBAL_COORDINATE;
    ASSERT_NO_FATAL_FAILURE(handler.UpdateOthersTouchEvent(pointerEvent, displayId, targetWindowIdMap, useCoordinate));
}

/**
 * @tc.name: ServerMsgHandlerTest_UpdateOtherTouchForDisplayCoordinate_002
 * @tc.desc: Test the function UpdateOtherTouchForDisplayCoordinate with valid display
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateOtherTouchForDisplayCoordinate_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    auto winMgr = std::static_pointer_cast<InputWindowsManager>(WIN_MGR);
    ASSERT_NE(winMgr, nullptr);
...
/**
 * @tc.name: ServerMsgHandlerTest_UpdateOtherTouchForGlobalCoordinate_003
 * @tc.desc: Test the function UpdateOtherTouchForGlobalCoordinate with coordinate out of range
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_UpdateOtherTouchForGlobalCoordinate_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    auto winMgr = std::static_pointer_cast<InputWindowsManager>(WIN_MGR);
    ASSERT_NE(winMgr, nullptr);
    ...
    ServerMsgHandler handler;
    PointerEvent::PointerItem pointerItem;
    pointerItem.SetGlobalX(5000);
    pointerItem.SetGlobalY(5000);
    bool result = handler.UpdateOtherTouchForGlobalCoordinate(pointerItem);
    EXPECT_FALSE(result);
}

/**
 * @tc.name: ServerMsgHandlerTest_OnTransferBinderClientSrv_003
 * @tc.desc: Test the function OnTransferBinderClientSrv with valid object
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_OnTransferBinderClientSrv_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    sptr<RemoteObjectTest> binderClientObject = new RemoteObjectTest(u"test");
...
/**
 * @tc.name: ServerMsgHandlerTest_LaunchAbility_001
 * @tc.desc: Test the function LaunchAbility
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_LaunchAbility_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
...
/**
 * @tc.name: ServerMsgHandlerTest_CheckForRequestInjectionFrequentAccess_003
 * @tc.desc: Test the function CheckForRequestInjectionFrequentAccess with multiple pids
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_CheckForRequestInjectionFrequentAccess_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    int32_t callingPid1 = 1111;
    int32_t callingPid2 = 2222;
    int64_t interval = 3000;
    bool result1 = handler.CheckForRequestInjectionFrequentAccess(callingPid1, interval);
    EXPECT_FALSE(result1);
    bool result2 = handler.CheckForRequestInjectionFrequentAccess(callingPid2, interval);
    EXPECT_FALSE(result2);
    bool result3 = handler.CheckForRequestInjectionFrequentAccess(callingPid1, interval);
    EXPECT_TRUE(result3);
}

/**
 * @tc.name: ServerMsgHandlerTest_GetRequestInjectionCallbackReqId_002
 * @tc.desc: Test the function GetRequestInjectionCallbackReqId multiple calls
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(ServerMsgHandlerTest, ServerMsgHandlerTest_GetRequestInjectionCallbackReqId_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    ServerMsgHandler handler;
    for (int i = 0; i < 10; i++) {
        int32_t reqId = handler.GetRequestInjectionCallbackReqId();
        EXPECT_GT(reqId, 0);
    }
}
} // namespace MMI
