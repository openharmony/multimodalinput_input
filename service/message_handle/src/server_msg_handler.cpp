    ...
    HandleEventType eventType, PriorityLevel priorityLevel)
{
    ...
    if (handlerType == InputHandlerType::INTERCEPTOR) {
        ...
        return interceptorHandler->AddInputHandler(handlerType, eventType, priorityLevel, sess);
    }
    ...
    HandleEventType eventType, PriorityLevel priorityLevel)
{
    ...
    if (handlerType == InputHandlerType::INTERCEPTOR) {
        auto interceptorHandler = InputHandler->GetInterceptorHandler();
        CHKPR(interceptorHandler, ERROR_NULL_POINTER);
        interceptorHandler->RemoveInputHandler(handlerType, eventType, priorityLevel, sess);
    }
#endif // OHOS_BUILD_ENABLE_INTERCEPTOR
#ifdef OHOS_BUILD_ENABLE_MONITOR
    if (handlerType == InputHandlerType::MONITOR) {
