...
/**
 * @tc.name: EventMonitorHandlerNewTest_OnHandleEvent_Pointer_ForceMonitor_001
...
/**
 * @tc.name: EventMonitorHandlerNewTest_CheckHasInputHandler_CombinedType_001
...
HWTEST_F(EventMonitorHandlerNewTest, EventMonitorHandlerNewTest_CheckHasInputHandler_CombinedType_001, TestSize.Level1)
{
    ...
    eventMonitorHandler.AddInputHandler(InputHandlerType::MONITOR,
        HANDLE_EVENT_TYPE_KEY | HANDLE_EVENT_TYPE_POINTER, callback, TOUCH_GESTURE_TYPE_NONE, 0);

    EXPECT_TRUE(eventMonitorHandler.CheckHasInputHandler(HANDLE_EVENT_TYPE_KEY));
    EXPECT_TRUE(eventMonitorHandler.CheckHasInputHandler(HANDLE_EVENT_TYPE_POINTER));
    EXPECT_TRUE(eventMonitorHandler.CheckHasInputHandler(HANDLE_EVENT_TYPE_KEY | HANDLE_EVENT_TYPE_POINTER));
}

/**
 * @tc.name: EventMonitorHandlerNewTest_AddInputHandler_DifferentHandlerTypes_001
...
HWTEST_F(EventMonitorHandlerNewTest, EventMonitorHandlerNewTest_AddInputHandler_DifferentHandlerTypes_001, TestSize.Level1)
{
    ...
    int32_t ret2 = eventMonitorHandler.AddInputHandler(InputHandlerType::INTERCEPTOR,
        HANDLE_EVENT_TYPE_KEY, callback, TOUCH_GESTURE_TYPE_NONE, 0);
    EXPECT_EQ(ret2, RET_OK);
}

/**
 * @tc.name: EventMonitorHandlerNewTest_AddInputHandler_RemoveActions_001
...
HWTEST_F(EventMonitorHandlerNewTest, EventMonitorHandlerNewTest_AddInputHandler_RemoveActions_001, TestSize.Level1)
{
    ...
    eventMonitorHandler.AddInputHandler(InputHandlerType::MONITOR, actionsType, session);

    ASSERT_NO_FATAL_FAILURE(eventMonitorHandler.RemoveInputHandler(InputHandlerType::MONITOR, actionsType, session));
}

/**
 * @tc.name: EventMonitorHandlerNewTest_AddInputHandler_UpdateEventType_001
...
/**
 * @tc.name: EventMonitorHandlerNewTest_HandleTouchEvent_MouseSource_001
...
/**
 * @tc.name: EventMonitorHandlerNewTest_HandleKeyEvent_EscapeKey_001
...
/**
 * @tc.name: EventMonitorHandlerNewTest_HandlePointerEvent_JoystickSource_001
