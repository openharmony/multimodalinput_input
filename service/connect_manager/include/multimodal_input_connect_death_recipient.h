...
#ifndef OHOS_MULTIMODAL_INPUT_CONNECT_DEATH_RECIPIENT_H
#define OHOS_MULTIMODAL_INPUT_CONNECT_DEATH_RECIPIENT_H
...
#endif // OHOS_MULTIMODAL_INPUT_CONNECT_DEATH_RECIPIENT_H
