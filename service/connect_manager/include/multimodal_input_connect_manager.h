...
public:
    ...
    int32_t AddInputHandler(InputHandlerType handlerType, HandleEventType eventType, PriorityLevel priorityLevel);
    int32_t RemoveInputHandler(InputHandlerType handlerType, HandleEventType eventType, PriorityLevel priorityLevel);
