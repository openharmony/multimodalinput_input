...
public:
    ...
    int32_t QuerySwitchStatus(int32_t switchType, int32_t& state) override { return RET_OK; };
    ...
    int32_t SetCurrentUser(int32_t userId) override { return retSetCurrentUser_; }
...
std::shared_ptr<Media::PixelMap> MMIServiceTest::CreatePixelMap(int32_t width, int32_t height)
{
    ...
    std::unique_ptr<Media::PixelMap> pixelMap = Media::PixelMap::Create(pixelColors, colorLen, opts);
    if (pixelMap == nullptr) {
        delete[] pixelColors;
        return nullptr;
    }
    delete[] pixelColors;
    std::shared_ptr<Media::PixelMap> srcPixelMap = std::move(pixelMap);
    return srcPixelMap;
}
 ...
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_024, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, ReadInterfaceToken()).WillOnce(Return(IMultimodalInputConnect::GetDescriptor()));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
#ifdef OHOS_BUILD_ENABLE_ANCO
/**
 * @tc.name: OnRemoteRequest_027
 * @tc.desc: Test the function OnRemoteRequest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_027, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, ReadInterfaceToken()).WillOnce(Return(IMultimodalInputConnect::GetDescriptor()));
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(false));
    ...
    MessageParcel reply;
    MessageOption option;
    uint32_t code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::ADD_ANCO_CHANNEL);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
}

/**
 * @tc.name: OnRemoteRequest_028
 * @tc.desc: Test the function OnRemoteRequest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_028, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, ReadInterfaceToken()).WillOnce(Return(IMultimodalInputConnect::GetDescriptor()));
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(false));
...
/**
 * @tc.name: OnRemoteRequest_029
 * @tc.desc: Test the function OnRemoteRequest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_029, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, ReadInterfaceToken()).WillOnce(Return(IMultimodalInputConnect::GetDescriptor()));
    ...
    MessageParcel reply;
    MessageOption option;
    uint32_t code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::TRANSFER_BINDER_CLIENT_SERVICE);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
}

/**
 * @tc.name: OnRemoteRequest_030
 * @tc.desc: Test the function OnRemoteRequest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_030, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, ReadInterfaceToken()).WillOnce(Return(IMultimodalInputConnect::GetDescriptor()));
    EXPECT_CALL(*messageParcelMock_, ReadRemoteObject()).WillOnce(Return(nullptr));
    ...
    MessageParcel reply;
    MessageOption option;
    uint32_t code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::SUBSCRIBE_HOT_KEY);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
}

/**
 * @tc.name: OnRemoteRequest_031
 * @tc.desc: Test the function OnRemoteRequest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_031, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, ReadInterfaceToken()).WillOnce(Return(IMultimodalInputConnect::GetDescriptor()));
    EXPECT_CALL(*messageParcelMock_, ReadRemoteObject()).WillOnce(Return(nullptr));
    ...
    MessageParcel reply;
    MessageOption option;
    uint32_t code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::UNSUBSCRIBE_HOT_KEY);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
}

/**
 * @tc.name: OnRemoteRequest_032
 * @tc.desc: Test the function OnRemoteRequest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_032, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, ReadInterfaceToken()).WillOnce(Return(IMultimodalInputConnect::GetDescriptor()));
    EXPECT_CALL(*messageParcelMock_, ReadRemoteObject()).WillOnce(Return(nullptr));
    ...
    MessageParcel reply;
    MessageOption option;
    uint32_t code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::SET_MOVE_EVENT_FILTERS);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
}
...
HWTEST_F(MultimodalInputConnectStubTest, StubHandleAllocSocketFd_007, TestSize.Level1)
{
    ...
    ASSERT_TRUE(ret == 0);
    EXPECT_CALL(*messageParcelMock_, ReadInt32()).WillOnce(Return(1));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillRepeatedly(DoAll(SetArgReferee<0>(sockFds[1]), Return(true)));
    EXPECT_CALL(*messageParcelMock_, ReadString()).WillRepeatedly(Return("success"));
    EXPECT_CALL(*messageParcelMock_, WriteFileDescriptor(_)).WillRepeatedly(Return(true));
...
HWTEST_F(MultimodalInputConnectStubTest, StubAddInputEventFilter_002, TestSize.Level1)
{
    ...
    EXPECT_CALL(*messageParcelMock_, CheckInputEventFilter()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    MessageParcel data;
    MessageParcel reply;
...
HWTEST_F(MultimodalInputConnectStubTest, StubAddInputEventFilter_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckInputEventFilter()).WillOnce(Return(true));
...
/**
 * @tc.name: StubRemoveInputEventFilter_004
 * @tc.desc: Test the function StubRemoveInputEventFilter
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubRemoveInputEventFilter_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckInputEventFilter()).WillOnce(Return(true));
...
/**
 * @tc.name: StubSetPointerStyle_003
 * @tc.desc: Test the function StubSetPointerStyle
 * @tc.type: FUNC
 * @tc.require:
 */
...
HWTEST_F(MultimodalInputConnectStubTest, StubSubscribeKeyEvent_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_))
        .WillOnce(DoAll(SetArgReferee<0>(-1), Return(false)))
        .WillOnce(DoAll(SetArgReferee<0>(1), Return(true)))
        .WillOnce(DoAll(SetArgReferee<0>(1), Return(true)))
        .WillOnce(DoAll(SetArgReferee<0>(1), Return(true)))
        .WillOnce(DoAll(SetArgReferee<0>(1), Return(true)))
...
/**
 * @tc.name: StubQuerySwitchStatus_001
 * @tc.desc: Test the function StubQuerySwitchStatus
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubQuerySwitchStatus_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ...
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubQuerySwitchStatus(data, reply));
}

/**
 * @tc.name: StubQuerySwitchStatus_002
 * @tc.desc: Test the function StubQuerySwitchStatus
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubQuerySwitchStatus_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: StubQuerySwitchStatus_003
 * @tc.desc: Test the function StubQuerySwitchStatus
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubQuerySwitchStatus_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillOnce(DoAll(SetArgReferee<0>(-1), Return(true)));
...
/**
 * @tc.name: StubQuerySwitchStatus_004
 * @tc.desc: Test the function StubQuerySwitchStatus
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubQuerySwitchStatus_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillOnce(DoAll(SetArgReferee<0>(0), Return(true)));
...
HWTEST_F(MultimodalInputConnectStubTest, StubMoveMouseEvent_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckMouseCursor()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    MessageParcel data;
    MessageParcel reply;
...
HWTEST_F(MultimodalInputConnectStubTest, StubMoveMouseEvent_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckMouseCursor()).WillOnce(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    MessageParcel data;
    MessageParcel reply;
...
/**
 * @tc.name: StubMoveMouseEvent_005
 * @tc.desc: Test the function StubMoveMouseEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubMoveMouseEvent_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckMouseCursor()).WillOnce(Return(true));
...
HWTEST_F(MultimodalInputConnectStubTest, StubSetPointerLocation_004, TestSize.Level1)
{
    ...
    EXPECT_CALL(*messageParcelMock_, CheckMouseCursor()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_))
        .WillRepeatedly(DoAll(SetArgReferee<0>(-1), Return(true)));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->state_ = ServiceRunningState::STATE_RUNNING;
...
/**
 * @tc.name: StubSetPointerLocation_005
 * @tc.desc: Test the function StubSetPointerLocation
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSetPointerLocation_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckMouseCursor()).WillOnce(Return(true));
...
HWTEST_F(MultimodalInputConnectStubTest, StubAuthorize_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckAuthorize()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    MessageParcel data;
    MessageParcel reply;
...
HWTEST_F(MultimodalInputConnectStubTest, StubAuthorize_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckAuthorize()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadBool(_)).WillOnce(DoAll(SetArgReferee<0>(true), Return(true)));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    MessageParcel data;
...
/**
 * @tc.name: StubAuthorize_004
 * @tc.desc: Test the function StubAuthorize
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubAuthorize_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckAuthorize()).WillOnce(Return(true));
...
HWTEST_F(MultimodalInputConnectStubTest, StubTransmitInfrared_003, TestSize.Level1)
{
    ...
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillOnce(DoAll(SetArgReferee<0>(1025), Return(true)));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    MessageParcel data;
    MessageParcel reply;
...
/**
 * @tc.name: StubRemoveVirtualInputDevice_003
 * @tc.desc: Test the function StubRemoveVirtualInputDevice
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubRemoveVirtualInputDevice_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillOnce(DoAll(SetArgReferee<0>(0), Return(true)));
...
HWTEST_F(MultimodalInputConnectStubTest, StubAddVirtualInputDevice_004, TestSize.Level1)
{
    ...
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillRepeatedly(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadString(_)).WillRepeatedly(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadUint64(_)).WillRepeatedly(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadUint32(_)).WillRepeatedly(DoAll(SetArgReferee<0>(0), Return(true)));
    EXPECT_CALL(*messageParcelMock_, WriteInt32(_)).WillRepeatedly(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
...
HWTEST_F(MultimodalInputConnectStubTest, StubGetTouchpadThreeFingersTapSwitch_002, TestSize.Level1)
{
    ...
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->retGetTouchpadThreeFingersTapSwitch_ = -1;
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubGetTouchpadThreeFingersTapSwitch(data, reply));
}
...
HWTEST_F(MultimodalInputConnectStubTest, StubGetTouchpadThreeFingersTapSwitch_003, TestSize.Level1)
{
    ...
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->retGetTouchpadThreeFingersTapSwitch_ = 0;
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubGetTouchpadThreeFingersTapSwitch(data, reply));
}
...
/**
 * @tc.name: StubSetTouchpadThreeFingersTapSwitch_003
 * @tc.desc: Test the function StubSetTouchpadThreeFingersTapSwitch
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSetTouchpadThreeFingersTapSwitch_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadBool(_)).WillOnce(DoAll(SetArgReferee<0>(false), Return(true)));
...
/**
 * @tc.name: StubGetTouchpadScrollRows_005
 * @tc.desc: Test the function StubGetTouchpadScrollRows
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubGetTouchpadScrollRows_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    auto stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: StubGetTouchpadScrollRows_006
 * @tc.desc: Test the function StubGetTouchpadScrollRows
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubGetTouchpadScrollRows_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, WriteInt32(_)).WillOnce(Return(true));
...
/**
 * @tc.name: MultimodalInputConnectStubTest_StubGetPointerSnapshot_002
 * @tc.desc: Cover if (ret == RET_OK) branch
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, MultimodalInputConnectStubTest_StubGetPointerSnapshot_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->state_ = ServiceRunningState::STATE_RUNNING;
    service->retSnapshot_ = RET_OK;
    service->pixelMap_ = std::make_shared<Media::PixelMap>();
    ASSERT_NE(service->pixelMap_, nullptr);
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubGetPointerSnapshot(data, reply));
}
...
/**
 * @tc.name: MultimodalInputConnectStubTest_StubGetPointerSnapshot_003
 * @tc.desc: Cover if (ret == RET_OK) branch
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, MultimodalInputConnectStubTest_StubGetPointerSnapshot_003, TestSize.Level1)
{
    ...
    service->state_ = ServiceRunningState::STATE_RUNNING;
    service->retSnapshot_ = RET_OK;
    service->pixelMap_ = service->CreatePixelMap(MIDDLE_PIXEL_MAP_WIDTH, MIDDLE_PIXEL_MAP_HEIGHT);
    ASSERT_NE(service->pixelMap_, nullptr);
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubGetPointerSnapshot(data, reply));
...
HWTEST_F(MultimodalInputConnectStubTest, MultimodalInputConnectStubTest_StubAncoAddChannel_001, TestSize.Level1)
{
    ...
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(true));
    sptr<RemoteObjectTest> remote = new RemoteObjectTest(u"test");
    EXPECT_CALL(*messageParcelMock_, ReadRemoteObject()).WillRepeatedly(Return(remote));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    ...
    MultimodalInputConnectStubTest_StubTransferBinderClientService, TestSize.Level1)
{
    ...
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->retTransferBinderClientSrv_ = RET_ERR;
    MessageParcel data;
    MessageParcel reply;
    ...
    MultimodalInputConnectStubTest_StubTransferBinderClientService_001, TestSize.Level1)
{
    ...
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->retTransferBinderClientSrv_ = RET_OK;
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubTransferBinderClientService(data, reply));
}
...
/**
 * @tc.name: StubGetIntervalSinceLastInput_001
 * @tc.desc: Test the function StubGetIntervalSinceLastInput
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubGetIntervalSinceLastInput_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    auto stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->retGetIntervalSinceLastInput_ = -1;
    MessageParcel data;
    MessageParcel reply;
...
/**
 * @tc.name: StubGetIntervalSinceLastInput_002
 * @tc.desc: Test the function StubGetIntervalSinceLastInput
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubGetIntervalSinceLastInput_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, WriteInt64(_)).WillOnce(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->retGetIntervalSinceLastInput_ = 0;
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubGetIntervalSinceLastInput(data, reply));
}
...
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_001, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    uint32_t code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::ADD_GESTURE_MONITOR);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
}
...
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_002, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    uint32_t code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::REMOVE_GESTURE_MONITOR);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
}
...
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_005, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    uint32_t code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::GET_SYSTEM_EVENT_TIME_INTERVAL);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
}
...
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_006, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    uint32_t code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::GET_ALL_SYSTEM_HOT_KEY);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
}
...
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_007, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    uint32_t code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::SET_CLIENT_INFO);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
}

/**
 * @tc.name: HandleGestureMonitor_001
 * @tc.desc: Test the function HandleGestureMonitor
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, HandleGestureMonitor_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    MultimodalinputConnectInterfaceCode code = MultimodalinputConnectInterfaceCode::ADD_VIRTUAL_INPUT_DEVICE;
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->HandleGestureMonitor(code, data, reply));
}

/**
 * @tc.name: HandleGestureMonitor_002
 * @tc.desc: Test the function HandleGestureMonitor
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, HandleGestureMonitor_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    MultimodalinputConnectInterfaceCode code = MultimodalinputConnectInterfaceCode::REMOVE_VIRTUAL_INPUT_DEVICE;
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->HandleGestureMonitor(code, data, reply));
}
...
/**
 * @tc.name: HandleGestureMonitor_003
 * @tc.desc: Test the function HandleGestureMonitor
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, HandleGestureMonitor_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckMonitor()).WillOnce(Return(false));
    ...
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->state_ = ServiceRunningState::STATE_RUNNING;
    MultimodalinputConnectInterfaceCode code = MultimodalinputConnectInterfaceCode::SET_THREE_GINGERS_TAPSWITCH;
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->HandleGestureMonitor(code, data, reply));
}
...
/**
 * @tc.name: HandleGestureMonitor_004
 * @tc.desc: Test the function HandleGestureMonitor
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, HandleGestureMonitor_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckMonitor()).WillOnce(Return(true));
    ...
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->state_ = ServiceRunningState::STATE_RUNNING;
    MultimodalinputConnectInterfaceCode code = MultimodalinputConnectInterfaceCode::GET_THREE_GINGERS_TAPSWITCH;
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->HandleGestureMonitor(code, data, reply));
}
...
/**
 * @tc.name: HandleGestureMonitor_005
 * @tc.desc: Test the function HandleGestureMonitor
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, HandleGestureMonitor_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckMonitor()).WillOnce(Return(true));
    ...
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->state_ = ServiceRunningState::STATE_RUNNING;
    MultimodalinputConnectInterfaceCode code = MultimodalinputConnectInterfaceCode::ADD_GESTURE_MONITOR;
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->HandleGestureMonitor(code, data, reply));
}
...
/**
 * @tc.name: HandleGestureMonitor_006
 * @tc.desc: Test the function HandleGestureMonitor
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, HandleGestureMonitor_006, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckMonitor()).WillRepeatedly(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillRepeatedly(DoAll(SetArgReferee<0>(1), Return(true)));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->state_ = ServiceRunningState::STATE_RUNNING;
    MultimodalinputConnectInterfaceCode code = MultimodalinputConnectInterfaceCode::REMOVE_GESTURE_MONITOR;
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->HandleGestureMonitor(code, data, reply));
}
...
/**
 * @tc.name: StubSkipPointerLayer_001
 * @tc.desc: Test the function StubSkipPointerLayer
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSkipPointerLayer_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, ReadBool(_)).WillOnce(DoAll(SetArgReferee<0>(true), Return(true)));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ...
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubSkipPointerLayer(data, reply));
}

/**
 * @tc.name: StubSkipPointerLayer_002
 * @tc.desc: Test the function StubSkipPointerLayer
 * @tc.type: FUNC
 * @tc.require:
 */
...
HWTEST_F(MultimodalInputConnectStubTest, OnRemoteRequest_008, TestSize.Level1)
{
    ...
    uint32_t code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::SUBSCRIBE_HOT_KEY);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
    code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::UNSUBSCRIBE_HOT_KEY);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
    code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::SUBSCRIBE_LONG_PRESS);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
    code = static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::UNSUBSCRIBE_LONG_PRESS);
    EXPECT_NO_FATAL_FAILURE(stub->OnRemoteRequest(code, data, reply, option));
}
...
/**
 * @tc.name: StubSubscribeHotkey_002
 * @tc.desc: Test the function StubSubscribeHotkey
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSubscribeHotkey_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: StubSubscribeHotkey_003
 * @tc.desc: Test the function StubSubscribeHotkey
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSubscribeHotkey_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: StubSubscribeHotkey_004
 * @tc.desc: Test the function StubSubscribeHotkey
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSubscribeHotkey_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillRepeatedly(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    std::shared_ptr<MMIServiceTest> service = std::static_pointer_cast<MMIServiceTest>(stub);
    service->state_ = ServiceRunningState::STATE_RUNNING;
...
/**
 * @tc.name: StubUnsubscribeHotkey_001
 * @tc.desc: Test the function StubUnsubscribeHotkey
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubUnsubscribeHotkey_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    ...
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubUnsubscribeHotkey(data, reply));
    service->state_ = ServiceRunningState::STATE_RUNNING;
    EXPECT_NO_FATAL_FAILURE(stub->StubUnsubscribeHotkey(data, reply));
}
...
HWTEST_F(MultimodalInputConnectStubTest, StubSubscribeLongPressEvent_001, TestSize.Level1)
{
    ...
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubSubscribeLongPressEvent(data, reply));
}
...
HWTEST_F(MultimodalInputConnectStubTest, StubUnsubscribeLongPressEvent_001, TestSize.Level1)
{
    ...
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubUnsubscribeLongPressEvent(data, reply));
}
...
/**
 * @tc.name: StubSetClientInfo_002
 * @tc.desc: Test the function StubSetClientInfo
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSetClientInfo_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
...
/**
 * @tc.name: StubGetCursorSurfaceId_001
 * @tc.desc: Test if (!PER_HELPER->VerifySystemApp())
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubGetCursorSurfaceId_001, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, WriteUint64(_)).WillOnce(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ...
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubGetCursorSurfaceId(data, reply));
}

/**
 * @tc.name: StubGetCursorSurfaceId_002
 * @tc.desc: Test if (!PER_HELPER->VerifySystemApp())
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubGetCursorSurfaceId_002, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
...
/**
 * @tc.name: StubGetCursorSurfaceId_003
 * @tc.desc: Test if (!IsRunning())
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubGetCursorSurfaceId_003, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, WriteUint64(_)).WillOnce(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
 ...
 * @tc.desc: Test if (!PER_HELPER->CheckMonitor())
 * @tc.type: FUNC
 * @tc.require:
 */
...
/**
 * @tc.name: StubAddPreInputHandler_004
 * @tc.desc: Test if (!PER_HELPER->CheckMonitor())
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubAddPreInputHandler_004, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckMonitor()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: StubRemovePreInputHandler_001
 * @tc.desc: Test if (!PER_HELPER->VerifySystemApp())
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubRemovePreInputHandler_001, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillOnce(DoAll(SetArgReferee<0>(-1), Return(true)));
    EXPECT_CALL(*messageParcelMock_, CheckMonitor()).WillOnce(Return(true));
    ...
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubRemovePreInputHandler(data, reply));
}

/**
 * @tc.name: StubRemovePreInputHandler_002
 * @tc.desc: Test if (!PER_HELPER->VerifySystemApp())
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubRemovePreInputHandler_002, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
...
/**
 * @tc.name: StubRemovePreInputHandler_003
 * @tc.desc: Test if (!IsRunning())
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubRemovePreInputHandler_003, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true)).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillOnce(DoAll(SetArgReferee<0>(-1), Return(true)));
    EXPECT_CALL(*messageParcelMock_, CheckMonitor()).WillOnce(Return(true));
...
/**
 * @tc.name: StubRemovePreInputHandler_004
 * @tc.desc: Test if (!PER_HELPER->CheckMonitor())
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubRemovePreInputHandler_004, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckMonitor()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillOnce(DoAll(SetArgReferee<0>(-1), Return(true)));
...
/**
 * @tc.name: StubRemovePreInputHandler_005
 * @tc.desc: Test if (!PER_HELPER->CheckMonitor())
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubRemovePreInputHandler_005, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, CheckMonitor()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: StubSetCustomMouseCursor_001
 * @tc.desc: Test if (!IsRunning())
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSetCustomMouseCursor_001, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_))
        .WillOnce(DoAll(SetArgReferee<0>(-1), Return(true)))
        .WillOnce(DoAll(SetArgReferee<0>(-1), Return(true)))
    ...
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubSetCustomMouseCursor(data, reply));
...
/**
 * @tc.name: MultimodalInputConnectStubTest_StubSetMultiWindowScreenId_001
 * @tc.desc: Test the function StubSetMultiWindowScreenId
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, MultimodalInputConnectStubTest_StubSetMultiWindowScreenId_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ...
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubSetMultiWindowScreenId(data, reply));
}

/**
 * @tc.name: MultimodalInputConnectStubTest_StubSetMultiWindowScreenId_002
 * @tc.desc: Test the function StubSetMultiWindowScreenId
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, MultimodalInputConnectStubTest_StubSetMultiWindowScreenId_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: MultimodalInputConnectStubTest_StubShiftAppPointerEvent_003
 * @tc.desc: Test the function StubShiftAppPointerEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, MultimodalInputConnectStubTest_StubShiftAppPointerEvent_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: MultimodalInputConnectStubTest_StubSkipPointerLayer_003
 * @tc.desc: Test the function StubSkipPointerLayer
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, MultimodalInputConnectStubTest_StubSkipPointerLayer_003, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: StubSetTouchpadThreeFingersTapSwitch_004
 * @tc.desc: Test the function StubSetTouchpadThreeFingersTapSwitch
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSetTouchpadThreeFingersTapSwitch_004, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: StubUnsubscribeKeyEvent_005
 * @tc.desc: Test the function StubUnsubscribeKeyEvent
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubUnsubscribeKeyEvent_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: StubSetMouseIcon_005
 * @tc.desc: Test the function StubSetMouseIcon
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSetMouseIcon_005, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillRepeatedly(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
...
/**
 * @tc.name: StubLaunchAiScreenAbility_001
 * @tc.desc: Test the function StubLaunchAiScreenAbility
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubLaunchAiScreenAbility_001, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
...
/**
 * @tc.name: StubSubscribeInputActive_001
 * @tc.desc: Test the function StubSubscribeInputActive
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSubscribeInputActive_001, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    ...
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubSubscribeInputActive(data, reply));
}

/**
 * @tc.name: StubSubscribeInputActive_002
 * @tc.desc: Test the function StubSubscribeInputActive
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSubscribeInputActive_002, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
...
/**
 * @tc.name: StubSubscribeInputActive_003
 * @tc.desc: Test the function StubSubscribeInputActive
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubSubscribeInputActive_003, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillOnce(DoAll(SetArgReferee<0>(-1), Return(true)));
    EXPECT_CALL(*messageParcelMock_, ReadInt64(_)).WillOnce(DoAll(SetArgReferee<0>(-1), Return(true)));
...
/**
 * @tc.name: StubUnsubscribeInputActive_001
 * @tc.desc: Test the function StubUnsubscribeInputActive
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubUnsubscribeInputActive_001, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(false));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
    ...
    MessageParcel data;
    MessageParcel reply;
    EXPECT_NO_FATAL_FAILURE(stub->StubUnsubscribeInputActive(data, reply));
}

/**
 * @tc.name: StubUnsubscribeInputActive_002
 * @tc.desc: Test the function StubUnsubscribeInputActive
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubUnsubscribeInputActive_002, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
    ASSERT_NE(stub, nullptr);
...
/**
 * @tc.name: StubUnsubscribeInputActive_003
 * @tc.desc: Test the function StubUnsubscribeInputActive
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(MultimodalInputConnectStubTest, StubUnsubscribeInputActive_003, TestSize.Level1)
{
    EXPECT_CALL(*messageParcelMock_, VerifySystemApp()).WillOnce(Return(true));
    EXPECT_CALL(*messageParcelMock_, ReadInt32(_)).WillOnce(DoAll(SetArgReferee<0>(-1), Return(true)));
    std::shared_ptr<MultimodalInputConnectStub> stub = std::make_shared<MMIServiceTest>();
