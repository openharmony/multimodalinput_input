...
int32_t MultimodalInputConnectProxy::SubscribeHotkey(int32_t subscribeId, const std::shared_ptr<KeyOption> keyOption)
{
    CALL_DEBUG_ENTER;
    CHKPR(keyOption, ERR_INVALID_VALUE);
    ...
    sptr<IRemoteObject> remote = Remote();
    CHKPR(remote, RET_ERR);
    int32_t ret = remote->SendRequest(static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::SUBSCRIBE_HOT_KEY),
        data, reply, option);
    if (ret != RET_OK) {
        MMI_HILOGE("Send request failed, result:%{public}d", ret);
    }
...
int32_t MultimodalInputConnectProxy::UnsubscribeHotkey(int32_t subscribeId)
{
    CALL_DEBUG_ENTER;
    MessageParcel data;
    if (!data.WriteInterfaceToken(MultimodalInputConnectProxy::GetDescriptor())) {
    ...
    sptr<IRemoteObject> remote = Remote();
    CHKPR(remote, RET_ERR);
    int32_t ret = remote->SendRequest(static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::UNSUBSCRIBE_HOT_KEY),
        data, reply, option);
    if (ret != RET_OK) {
        MMI_HILOGE("Send request failed, result:%{public}d", ret);
    }
...
int32_t MultimodalInputConnectProxy::SetTouchpadScrollRows(int32_t rows)
{
    ...
    CHKPR(remote, RET_ERR);
    int32_t ret = remote->SendRequest(
        static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::SET_TOUCHPAD_SCROLL_ROWS), data, reply, option);
    if (ret != RET_OK) {
        MMI_HILOGE("Send request failed, ret:%{public}d", ret);
    }
    return ret;
...
int32_t MultimodalInputConnectProxy::GetTouchpadScrollRows(int32_t &rows)
{
    CALL_DEBUG_ENTER;
    MessageParcel data;
    if (!data.WriteInterfaceToken(MultimodalInputConnectProxy::GetDescriptor())) {
    ...
    CHKPR(remote, RET_ERR);
    int32_t ret = remote->SendRequest(
        static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::GET_TOUCHPAD_SCROLL_ROWS), data, reply, option);
    if (ret != RET_OK) {
        MMI_HILOGE("Send request failed, ret:%{public}d", ret);
        return ret;
    }
    ...
    CursorOptions options) __attribute__((no_sanitize("cfi")))
{
    ...
    WRITEINT32(data, windowId, ERR_INVALID_VALUE);
    pixelMapPtr->Marshalling(data);
    WRITEINT32(data, cursor.focusX, ERR_INVALID_VALUE);
    WRITEINT32(data, cursor.focusY, ERR_INVALID_VALUE);
    WRITEBOOL(data, options.followSystem, ERR_INVALID_VALUE);
    ...
    CHKPR(remote, RET_ERR);
    int32_t ret =
        remote->SendRequest(static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::SET_CUSTOM_MOUSE_CURSOR),
            data, reply, option);
    if (ret != RET_OK) {
        MMI_HILOGE("Send request failed, ret:%{public}d", ret);
    } else {
...
int32_t MultimodalInputConnectProxy::SetKnuckleSwitch(bool knuckleSwitch)
{
    CALL_DEBUG_ENTER;
    MessageParcel data;
    if (!data.WriteInterfaceToken(MultimodalInputConnectProxy::GetDescriptor())) {
    ...
    WRITEBOOL(data, knuckleSwitch, ERR_INVALID_VALUE);
    MessageParcel reply;
    MessageOption option;
    sptr<IRemoteObject> remote = Remote();
    CHKPR(remote, RET_ERR);
    int32_t ret = remote->SendRequest(
        static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::SET_KNUCKLE_SWITCH),
        data, reply, option);
    if (ret != RET_OK) {
        MMI_HILOGE("Send request fail, ret:%{public}d", ret);
    }
...
int32_t MultimodalInputConnectProxy::LaunchAiScreenAbility()
{
    CALL_DEBUG_ENTER;
    MessageParcel data;
    if (!data.WriteInterfaceToken(MultimodalInputConnectProxy::GetDescriptor())) {
    ...
    CHKPR(remote, RET_ERR);
    int32_t ret = remote->SendRequest(
        static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::LAUNCH_AI_SCREEN_ABILITY),
        data, reply, option);
    if (ret != RET_OK) {
        MMI_HILOGE("Send request failed, ret:%{public}d", ret);
    }
...
int32_t MultimodalInputConnectProxy::SubscribeInputActive(int32_t subscribeId, int64_t interval)
{
    CALL_DEBUG_ENTER;
    MessageParcel data;
    if (!data.WriteInterfaceToken(MultimodalInputConnectProxy::GetDescriptor())) {
    ...
    WRITEINT32(data, subscribeId, ERR_INVALID_VALUE);
    WRITEINT64(data, interval, ERR_INVALID_VALUE);
    ...
    CHKPR(remote, RET_ERR);
    int32_t ret = remote->SendRequest(
        static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::SUBSCRIBE_INPUT_ACTIVE),
        data, reply, option);
    if (ret != RET_OK) {
        MMI_HILOGE("Send request failed, ret:%{public}d", ret);
    }
...
int32_t MultimodalInputConnectProxy::UnsubscribeInputActive(int32_t subscribeId)
{
    CALL_DEBUG_ENTER;
    MessageParcel data;
    if (!data.WriteInterfaceToken(MultimodalInputConnectProxy::GetDescriptor())) {
    ...
    CHKPR(remote, RET_ERR);
    int32_t ret = remote->SendRequest(
        static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::UNSUBSCRIBE_INPUT_ACTIVE),
        data, reply, option);
    if (ret != RET_OK) {
        MMI_HILOGE("Send request failed, ret:%{public}d", ret);
    }
...
int32_t MultimodalInputConnectProxy::SwitchTouchTracking(bool touchTracking)
{
    CALL_DEBUG_ENTER;
    MessageParcel data;
    if (!data.WriteInterfaceToken(MultimodalInputConnectProxy::GetDescriptor())) {
    ...
    WRITEBOOL(data, touchTracking, ERR_INVALID_VALUE);
    MessageParcel reply;
    MessageOption option;
    sptr<IRemoteObject> remote = Remote();
    CHKPR(remote, RET_ERR);
    auto ret = remote->SendRequest(
        static_cast<uint32_t>(MultimodalinputConnectInterfaceCode::SWITCH_TOUCH_TRACKING),
        data, reply, option);
    if (ret != RET_OK) {
        MMI_HILOGE("Send request failed, ret:%{public}d", ret);
    }
