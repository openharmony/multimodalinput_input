...
int32_t MouseEventHandler::GetSpeed(int32_t deviceId) const
{
...
bool MouseEventHandler::GetSpeedGain(double vin, double& gain, int32_t deviceId) const
{
...
int32_t MouseEventHandler::HandleMotionInner(struct libinput_event_pointer* data, int32_t deviceId)
{
    CALL_DEBUG_ENTER;
...
int32_t MouseEventHandler::HandleMotionAccelerate(struct libinput_event_pointer* data, int32_t deviceId)
{
    CHKPR(data, ERROR_NULL_POINTER);
