...
int32_t MouseEventNormalize::HandleMotionInner(struct libinput_event_pointer* data, int32_t deviceId)
{
    CALL_DEBUG_ENTER;
...
int32_t MouseEventNormalize::HandleMotionAccelerate(struct libinput_event_pointer* data, int32_t deviceId)
{
    CHKPR(data, ERROR_NULL_POINTER);
