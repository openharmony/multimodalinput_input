...
const std::string SYS_GET_DEVICE_TYPE_PARAM {
    PRODUCT_NAME_DEFINITION_PARSER.GetProductName("SYS_GET_DEVICE_TYPE_PARAM") };
const std::vector<std::string> DEVICE_TYPE_TABLET_A1_VECTOR {
    PRODUCT_NAME_DEFINITION_PARSER.GetProductNameVector("DEVICE_TYPE_TABLET_A1")
};
