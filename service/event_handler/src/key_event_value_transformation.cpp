...
const std::multimap<int32_t, KeyEventValueTransformation> MAP_KEY_EVENT_VALUE_TRANSFORMATION = {
    ...
    {252, {"KEY_XKEY", 252, 3232, HOS_KEY_XKEY}},
    ...
    {745, {"KEY_MOUSE_ASSISTANT", 745, 2732, HOS_KEY_MOUSE_ASSISTANT}},
    {746, {"KEY_MOUSE_INTELLIGENCE_SELECTION", 746, 2733, HOS_KEY_MOUSE_INTELLIGENCE_SELECTION}},
    ...
    {757, {"KEY_PEN_MODE_SWITCH", 757, 3221, HOS_KEY_PEN_MODE_SWITCH}},
    {758, {"KEY_PEELING", 758, 16777217, HOS_KEY_PEELING}},
    {760, {"DAGGER_CLICK", 760, 3211, DAGGER_CLICK}},
    {761, {"DAGGER_DOUBLE_CLICK", 761, 3212, DAGGER_DOUBLE_CLICK}},
    {762, {"DAGGER_LONG_PRESS", 762, 3213, DAGGER_LONG_PRESS}},
    {763, {"HOS_KEYCODE_AOD_SLIDE_UNLOCK", 763, 3219, HOS_KEYCODE_AOD_SLIDE_UNLOCK}},
    {764, {"KEY_DIV", 764, 3220, HOS_KEY_DIV}},
    {765, {"KEY_AOD_SINGLE_CLICK", 765, 2740, HOS_KEY_AOD_SINGLE_CLICK}},
    {767, {"MMX_TOUCH", 767, 3222, HOS_KEY_MMX_TOUCH}},
    {747, {"KEY_FINGERPRINT_SLIDE_UP", 747, 3233, HOS_KEY_FINGERPRINT_SLIDE_UP}},
    {748, {"KEY_FINGERPRINT_SLIDE_DOWN", 748, 3234, HOS_KEY_FINGERPRINT_SLIDE_DOWN}},
    {768, {"KEY_PTZ_CLICK", 768, 3235, HOS_KEY_PTZ_CLICK}},
    {769, {"KEY_PTZ_FOCUS_LEFT", 769, 3236, HOS_KEY_PTZ_FOCUS_LEFT}},
    {770, {"KEY_PTZ_FOCUS_RIGHT", 770, 3237, HOS_KEY_PTZ_FOCUS_RIGHT}},
    {771, {"KEY_PTZ_EXPOSE_LEFT", 771, 3238, HOS_KEY_PTZ_EXPOSE_LEFT}},
    {772, {"KEY_PTZ_EXPOSE_RIGHT", 772, 3239, HOS_KEY_PTZ_EXPOSE_RIGHT}},
    {773, {"KEY_PTZ_SHUTTER_LEFT", 773, 3240, HOS_KEY_PTZ_SHUTTER_LEFT}},
    {774, {"KEY_PTZ_SHUTTER_RIGHT", 774, 3241, HOS_KEY_PTZ_SHUTTER_RIGHT}},
    {775, {"KEY_PTZ_APERTURE_LEFT", 775, 3242, HOS_KEY_PTZ_APERTURE_LEFT}},
    {776, {"KEY_PTZ_APERTURE_RIGHT", 776, 3243, HOS_KEY_PTZ_APERTURE_RIGHT}},
    {759, {"KEY_PEN_WRITING_MOUSE", 759, 3251, HOS_KEY_PEN_WRITING_MOUSE}},
    {749, {"KEY_BACK_PANEL_DOUBLE_TAP", 749, 16842752, HOS_KEY_BACK_PANEL_DOUBLE_TAP}},
    {750, {"KEY_LIFT_PEN", 750, 16842753, HOS_KEY_LIFT_PEN}},
    {751, {"KEY_DOWN_PEN", 751, 16842754, HOS_KEY_DOWN_PEN}},
#else
    {142, {"KEY_SLEEP", 142, 2600, HOS_KEY_SLEEP}},
    {143, {"KEY_WAKEUP", 143, 2802, HOS_KEY_WAKEUP}},
    {766, {"KEY_FUNCTION", 766, 2078, HOS_KEY_FUNCTION}},
