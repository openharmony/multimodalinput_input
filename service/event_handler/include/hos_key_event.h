...
enum HosKeyEventEnum {
    ...
    HOS_KEY_MOUSE_ASSISTANT = 2732,
    HOS_KEY_MOUSE_INTELLIGENCE_SELECTION = 2733,
    HOS_KEY_AOD_SINGLE_CLICK = 2740,
    ...
    HOS_KEY_PTZ_CLICK = 3235,
    HOS_KEY_PTZ_FOCUS_LEFT = 3236,
    HOS_KEY_PTZ_FOCUS_RIGHT = 3237,
    HOS_KEY_PTZ_EXPOSE_LEFT = 3238,
    HOS_KEY_PTZ_EXPOSE_RIGHT = 3239,
    HOS_KEY_PTZ_SHUTTER_LEFT = 3240,
    HOS_KEY_PTZ_SHUTTER_RIGHT = 3241,
    HOS_KEY_PTZ_APERTURE_LEFT = 3242,
    HOS_KEY_PTZ_APERTURE_RIGHT = 3243,
    HOS_KEY_PEN_WRITING_MOUSE = 3251,
    HOS_KEY_PEELING = 16777217,
    HOS_KEY_BACK_PANEL_DOUBLE_TAP = 16842752,
    HOS_KEY_LIFT_PEN = 16842753,
    HOS_KEY_DOWN_PEN = 16842754,
