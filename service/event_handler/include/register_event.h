...
protected:
    ...
    static constexpr int32_t KEY_MULTITASK = 0x280; /* virtual multitask key */
    static constexpr int32_t KEY_SCREENSHOT = 0x281; /* remote SCREENSHOT key */
    ...
    static constexpr int32_t MOVEXDISTANCE = 50;
    static constexpr int32_t MAXY = 1000;
    static constexpr int32_t MAXX = 500;
    static constexpr int32_t MINY = 0;
    static constexpr int32_t MINX = 0;
    static constexpr int32_t REGION = 50;
    static constexpr int32_t ONEFINGER = 1;
    static constexpr int32_t THREEFINGER = 3;
    static constexpr int32_t PRESS = 1;
    static constexpr int32_t RELEASE = 0;
    static constexpr int32_t BIT0 = 0;
    static constexpr int32_t BIT1 = 1;
    static constexpr int32_t BIT2 = 2;
    static constexpr int32_t BIT3 = 3;
    static constexpr int32_t BIT4 = 4;
    static constexpr int32_t BIT5 = 5;
    static constexpr int32_t BIT6 = 6;
};
} // namespace MMI
} // namespace OHOS
