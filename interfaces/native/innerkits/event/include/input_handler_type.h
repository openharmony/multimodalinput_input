...
inline constexpr HandleEventType HANDLE_EVENT_TYPE_FINGERPRINT { 1u << 12 };
inline constexpr HandleEventType HANDLE_EVENT_TYPE_X_KEY { 1u << 13 };
inline constexpr HandleEventType HANDLE_EVENT_TYPE_ALL {
    ...
    HANDLE_EVENT_TYPE_PRE_KEY | HANDLE_EVENT_TYPE_FINGERPRINT | HANDLE_EVENT_TYPE_X_KEY
};
