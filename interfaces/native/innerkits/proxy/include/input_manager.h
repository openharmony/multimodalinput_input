...
public:
    ...
    int32_t AddInterceptor(std::shared_ptr<IInputEventConsumer> interceptor, PriorityLevel priorityLevel);
    int32_t AddInterceptor(std::function<void(std::shared_ptr<KeyEvent>)> interceptor, PriorityLevel priorityLevel);
