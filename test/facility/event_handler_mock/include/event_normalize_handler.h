...
#ifndef MMI_EVENT_NORMALIZE_HANDLER_MOCK_H
#define MMI_EVENT_NORMALIZE_HANDLER_MOCK_H
#include <memory>
...
class EventNormalizeHandler final : public IEventNormalizeHandler {
public:
    EventNormalizeHandler() = default;
    ~EventNormalizeHandler() override = default;
...
#endif // MMI_EVENT_NORMALIZE_HANDLER_MOCK_H