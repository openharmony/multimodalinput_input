...
#include "getkeyboardrepeatdelay_fuzzer.h"
...
#undef LOG_TAG
#define LOG_TAG "GetKeyBoardRepeatDelayFuzzTest"
...
bool GetKeyBoardRepeatDelayFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_GET_KEYBOARD_REPEAT_DELAY), datas, reply, option);
    return true;
}
} // namespace OHOS
