...
#include "stubsetpointerstyle_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubSetPointerStyleFuzzTest"
...
bool StubSetPointerStyleFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_SET_POINTER_STYLE), datas, reply, option);
    return true;
}
} // namespace OHOS
