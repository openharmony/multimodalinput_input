...
#include "getpointersize_fuzzer.h"
...
#undef LOG_TAG
#define LOG_TAG "GetPointerSizeFuzzTest"
...
bool GetPointerSizeFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_GET_POINTER_SIZE), datas, reply, option);
    return true;
}
} // namespace OHOS
