...
#include "eventenablehardwarecursorstats_fuzzer.h"

#include "input_manager.h"

namespace OHOS {
namespace MMI {
void EventEnableHardwareCursorStatsFuzzTest(FuzzedDataProvider &fdp)
{
...
{
    EventEnableHardwareCursorStatsFuzzTest(fdp);
    return true;
}
} // namespace MMI
} // namespace OHOS
