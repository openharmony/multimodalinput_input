...
#include "setshieldstatus_fuzzer.h"
...
#undef LOG_TAG
#define LOG_TAG "SetShieldStatusFuzzTest"
...
bool SetShieldStatusFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_SET_SHIELD_STATUS), datas, reply, option);
    return true;
}
} // namespace OHOS
