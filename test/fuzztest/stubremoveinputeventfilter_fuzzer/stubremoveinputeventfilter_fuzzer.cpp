...
#include "stubremoveinputeventfilter_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubRemoveInputEventFilterFuzzTest"
...
bool StubRemoveInputEventFilterFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_REMOVE_INPUT_EVENT_FILTER), datas, reply, option);
    return true;
}
} // namespace OHOS
