...
#include "notifynaponline_fuzzer.h"
...
#undef LOG_TAG
#define LOG_TAG "NotifyNapOnlineFuzzTest"
...
bool NotifyNapOnlineFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(MMI::IMultimodalInputConnectIpcCode::COMMAND_NOTIFY_NAP_ONLINE), datas, reply, option);
    return true;
}
} // namespace OHOS
