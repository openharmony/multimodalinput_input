...
#include "stubgetpointerspeed_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubGetPointerSpeedFuzzTest"
...
bool StubGetPointerSpeedFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_GET_POINTER_SPEED), datas, reply, option);
    return true;
}
} // namespace OHOS
