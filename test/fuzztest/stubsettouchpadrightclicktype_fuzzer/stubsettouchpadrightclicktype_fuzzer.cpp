...
#include "stubsettouchpadrightclicktype_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubSetTouchpadRightClickTypeFuzzTest"
...
bool StubSetTouchpadRightClickTypeFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_SET_TOUCHPAD_RIGHT_CLICK_TYPE),
        datas, reply, option);
    return true;
}
} // namespace OHOS
