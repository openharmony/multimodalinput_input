...
#include "connectmanagersetmousehotspot_fuzzer.h"
...
namespace OHOS {
namespace MMI {
void ConnectManagerSetMouseHotSpotFuzzTest(FuzzedDataProvider &fdp)
{
    ...
    MultimodalInputConnectManager::GetInstance()->SetMouseHotSpot(pid, windowId, hotX, hotY);
}

bool MmiServiceFuzzTest(FuzzedDataProvider &fdp)
{
    ConnectManagerSetMouseHotSpotFuzzTest(fdp);
    return true;
}
} // namespace MMI
} // namespace OHOS
