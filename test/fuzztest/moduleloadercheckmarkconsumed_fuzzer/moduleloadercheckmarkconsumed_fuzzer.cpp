...
#include "moduleloadercheckmarkconsumed_fuzzer.h"

#include "mmi_service.h"

namespace OHOS {
namespace MMI {
void ModuleLoaderCheckMarkConsumedFuzzTest(FuzzedDataProvider &fdp)
{
...
{
    ModuleLoaderCheckMarkConsumedFuzzTest(fdp);
    return true;
}
} // namespace MMI
} // namespace OHOS
