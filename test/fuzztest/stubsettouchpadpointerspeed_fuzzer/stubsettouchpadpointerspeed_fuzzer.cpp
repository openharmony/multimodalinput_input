...
#include "stubsettouchpadpointerspeed_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubSetTouchpadPointerSpeedFuzzTest"
...
bool StubSetTouchpadPointerSpeedFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_SET_TOUCHPAD_POINTER_SPEED),
        datas, reply, option);
    return true;
}
} // namespace OHOS
