...
#include "gettprightclicktype_fuzzer.h"
...
#undef LOG_TAG
#define LOG_TAG "GetTpRightClickTypeFuzzTest"
...
bool GetTpRightClickTypeFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_GET_TOUCHPAD_RIGHT_CLICK_TYPE),
        datas, reply, option);
    return true;
}
} // namespace OHOS
