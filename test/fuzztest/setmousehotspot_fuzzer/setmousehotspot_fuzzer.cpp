...
#include "setmousehotspot_fuzzer.h"
...
#undef LOG_TAG
#define LOG_TAG "SetMouseHotSpotFuzzTest"
...
bool SetMouseHotSpotFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_SET_MOUSE_HOT_SPOT), datas, reply, option);
    return true;
}
} // namespace OHOS
