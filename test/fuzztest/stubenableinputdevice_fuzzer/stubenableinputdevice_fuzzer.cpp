...
#include "stubenableinputdevice_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubEnableInputDeviceFuzzTest"
...
bool StubEnableInputDeviceFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_ENABLE_INPUT_DEVICE), datas, reply, option);
    return true;
}
} // namespace OHOS
