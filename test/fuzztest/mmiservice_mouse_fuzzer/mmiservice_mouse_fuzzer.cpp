...
#include "mmiservice_mouse_fuzzer.h"
...
void MouseFuzzTest(FuzzedDataProvider &fdp)
{
    ...
    int32_t primaryButton1 = fdp.ConsumeIntegral<int32_t>();
    MMIService::GetInstance()->SetMousePrimaryButton(primaryButton1);

    int32_t primaryButton2 = fdp.ConsumeIntegral<int32_t>();
    MMIService::GetInstance()->GetMousePrimaryButton(primaryButton2);
