...
#include "stubgetfunctionkeystate_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubGetFunctionKeyStateFuzzTest"
...
bool StubGetFunctionKeyStateFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_GET_FUNCTION_KEY_STATE), datas, reply, option);
    return true;
}
} // namespace OHOS
