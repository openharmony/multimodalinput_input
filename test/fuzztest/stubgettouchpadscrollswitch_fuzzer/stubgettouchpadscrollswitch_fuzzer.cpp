...
#include "stubgettouchpadscrollswitch_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubGetTouchpadScrollSwitchFuzzTest"
...
bool StubGetTouchpadScrollSwitchFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_GET_TOUCHPAD_SCROLL_SWITCH),
        datas, reply, option);
    return true;
}
} // namespace OHOS
