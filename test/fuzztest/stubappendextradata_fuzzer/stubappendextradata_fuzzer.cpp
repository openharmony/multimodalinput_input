...
#include "stubappendextradata_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubAppendExtraDataFuzzTest"
...
bool StubAppendExtraDataFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_APPEND_EXTRA_DATA), datas, reply, option);
    return true;
}
} // namespace OHOS
