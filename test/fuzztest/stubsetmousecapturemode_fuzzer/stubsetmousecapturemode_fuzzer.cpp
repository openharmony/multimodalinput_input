...
#include "stubsetmousecapturemode_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubSetMouseCaptureModeFuzzTest"
...
bool StubSetMouseCaptureModeFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_SET_MOUSE_CAPTURE_MODE), datas, reply, option);
