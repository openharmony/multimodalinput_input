...
#include "gettouchscreenkeyboardtype_fuzzer.h"
#include "fuzzer/FuzzedDataProvider.h"

#include "securec.h"

#undef MMI_LOG_TAG
#define MMI_LOG_TAG "GetTouchscreenKeyboardTypeFuzzTest"

namespace OHOS {
namespace MMI {
bool GetTouchscreenKeyboardTypeFuzzTest(const uint8_t *data, size_t size)
{
    ...
    INPUT_DEV_MGR->GetTouchscreenKeyboardType(deviceInfo, keyboardType);
    return true;
}
} // namespace MMI
} // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::MMI::GetTouchscreenKeyboardTypeFuzzTest(data, size);
    return 0;
}