...
#include "stubsettouchpadpinchswitch_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubSetTouchpadPinchSwitchFuzzTest"
...
bool StubSetTouchpadPinchSwitchFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_SET_TOUCHPAD_PINCH_SWITCH), datas, reply, option);
    return true;
}
} // namespace OHOS
