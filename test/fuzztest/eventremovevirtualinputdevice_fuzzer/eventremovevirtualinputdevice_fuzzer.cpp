...
#include "eventremovevirtualinputdevice_fuzzer.h"

#include "input_manager.h"

namespace OHOS {
namespace MMI {
void EventRemoveVirtualInputDeviceFuzzTest(FuzzedDataProvider &fdp)
{
...
{
    EventRemoveVirtualInputDeviceFuzzTest(fdp);
    return true;
}
} // namespace MMI
} // namespace OHOS
