...
#include "mmiservice_device_fuzzer.h"

#include "mmi_service.h"

namespace OHOS {
namespace MMI {
void DeviceFuzzTest(FuzzedDataProvider &fdp)
{
    ...
    std::vector<bool> keystroke = {fdp.ConsumeBool()};
    MMIService::GetInstance()->OnSupportKeys(deviceId, keys, keystroke);

    std::vector<int32_t> ids = {fdp.ConsumeIntegral<int32_t>(), fdp.ConsumeIntegral<int32_t>()};
