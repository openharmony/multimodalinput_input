...
#include "stubgetdisplaybindinfo_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubGetDisplayBindInfoFuzzTest"
...
bool StubGetDisplayBindInfoFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_GET_DISPLAY_BIND_INFO), datas, reply, option);
    return true;
}
} // namespace OHOS
