...
#include "eventunsubscribeLongpressevent_fuzzer.h"

#include "input_manager.h"

namespace OHOS {
namespace MMI {
void EventUnsubscribeLongPressEventFuzzTest(FuzzedDataProvider &fdp)
{
...
{
    EventUnsubscribeLongPressEventFuzzTest(fdp);
    return true;
}
} // namespace MMI
} // namespace OHOS
