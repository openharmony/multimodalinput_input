...
#include "getpointercolor_fuzzer.h"
...
#undef LOG_TAG
#define LOG_TAG "GetPointerColorFuzzTest"
...
bool GetPointerColorFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_GET_POINTER_COLOR), datas, reply, option);
    return true;
}
} // namespace OHOS
