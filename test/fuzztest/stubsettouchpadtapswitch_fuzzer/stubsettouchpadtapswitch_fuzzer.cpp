...
#include "stubsettouchpadtapswitch_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubSetTouchpadTapSwitchFuzzTest"
...
bool StubSetTouchpadTapSwitchFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_SET_TOUCHPAD_TAP_SWITCH), datas, reply, option);
    return true;
}
} // namespace OHOS
