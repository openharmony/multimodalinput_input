...
#include "moduleloader_shield_ir_fuzzer.h"

#include "mmi_service.h"

namespace OHOS {
namespace MMI {
void ShieldIrFuzzTest(FuzzedDataProvider &fdp)
{
    ...
    bool hasIr = fdp.ConsumeBool();
    MMIService::GetInstance()->HasIrEmitter(hasIr);
    ...
    int32_t authStatus = fdp.ConsumeIntegral<int32_t>();
    MMIService::GetInstance()->QueryAuthorizedStatus(authStatus);
}
