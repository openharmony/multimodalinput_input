...
#include "enablecombinekey_fuzzer.h"
...
#undef LOG_TAG
#define LOG_TAG "EnableCombineKeyFuzzTest"
...
bool EnableCombineKeyFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_ENABLE_COMBINE_KEY), datas, reply, option);
    return true;
}
} // namespace OHOS
