...
#include "moduleloadergetcursorsurfaceid_fuzzer.h"

#include "mmi_service.h"

namespace OHOS {
namespace MMI {
void ModuleLoaderGetCursorSurfaceIdFuzzTest(FuzzedDataProvider &fdp)
{
...
{
    ModuleLoaderGetCursorSurfaceIdFuzzTest(fdp);
    return true;
}
} // namespace MMI
} // namespace OHOS
