...
#include "stubgettouchpadpinchswitch_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubGetTouchpadPinchSwitchFuzzTest"
...
bool StubGetTouchpadPinchSwitchFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_GET_TOUCHPAD_PINCH_SWITCH), datas, reply, option);
    return true;
}
} // namespace OHOS
