...
void CustomCursorParcelFuzzTest(const uint8_t *data, size_t size)
{
    ...
    Parcel parcelOut;
    cursorParcel.Marshalling(parcelOut);
    Parcel parcelIn;
    cursorParcel.ReadFromParcel(parcelIn);
    cursorParcel.Unmarshalling(parcelIn);
}
} // MMI
} // OHOS
