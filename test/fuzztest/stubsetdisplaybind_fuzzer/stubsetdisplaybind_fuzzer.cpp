...
#include "stubsetdisplaybind_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubSetDisplayBindFuzzTest"
...
bool StubSetDisplayBindFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_SET_DISPLAY_BIND), datas, reply, option);
    return true;
}
} // namespace OHOS
