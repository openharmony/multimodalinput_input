...
void StubHandleKeyEventFuzzTest(const uint8_t *data, size_t size)
{
    ...
    KeyOption keyOption;
    keyOption.finalKey_ = provider.ConsumeIntegral<int32_t>();
    keyOption.isFinalKeyDown_ = provider.ConsumeIntegral<int32_t>();
    keyOption.finalKeyDownDuration_ = provider.ConsumeBool();
    keyOption.finalKeyUpDelay_ = provider.ConsumeIntegral<int32_t>();
