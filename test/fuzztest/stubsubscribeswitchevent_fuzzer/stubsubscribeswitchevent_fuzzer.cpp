...
#include "stubsubscribeswitchevent_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubSubscribeSwitchEventFuzzTest"
...
bool StubSubscribeSwitchEventFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_SUBSCRIBE_SWITCH_EVENT), datas, reply, option);
    return true;
}
} // namespace OHOS
