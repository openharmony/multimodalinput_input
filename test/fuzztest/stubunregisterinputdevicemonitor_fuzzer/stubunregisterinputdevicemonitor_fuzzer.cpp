...
#include "stubunregisterinputdevicemonitor_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubUnregisterInputDeviceMonitorFuzzTest"
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::MMI::StubUnregisterInputDeviceMonitorFuzzTest(data, size);
    return 0;
}
