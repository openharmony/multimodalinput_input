...
#include "stubgetmousescrollrows_fuzzer.h"
...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "StubGetMouseScrollRowsFuzzTest"
...
bool StubGetMouseScrollRowsFuzzTest(const uint8_t* data, size_t size)
{
    ...
    MMIService::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(IMultimodalInputConnectIpcCode::COMMAND_GET_MOUSE_SCROLL_ROWS), datas, reply, option);
    return true;
}
} // namespace OHOS
