...
#undef MMI_LOG_TAG
#define MMI_LOG_TAG "PointerEvent4FuzzTest"

namespace OHOS {
namespace MMI {
void PointerEvent4FuzzTest(const uint8_t *data, size_t size)
{
    ...
    MMI_HILOGD("PointerEvent4FuzzTest");
}
} // MMI
} // OHOS
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::MMI::PointerEvent4FuzzTest(data, size);
    return 0;
}
