...
inline constexpr int32_t ERROR_PIXELMAP_MANAGED { -1005 };
...
enum : int32_t {
    ERROR_INVALID_SUBSCRIBE_ID = INT_MIN,
    ERROR_INIT_CLIENT_FAILED,
    ERROR_SUBSCRIBE_SERVER_FAILED,
    ERROR_SUBSCRIBEID_NOT_EXIST,
    ERROR_UNSUBSCRIBE_SERVER_FAILED,
    ERROR_FIND_SUBSCRIBEID_FAILED,
    ERROR_ONE_PROCESS_ONLY_SUPPORT_ONE,
    ERROR_ALLOC_SUBSCRIBEINFO_FAILED,
    ERROR_NO_SUBSCRIBE_INPUT_ACTIVE,
    ERROR_HAD_UNSUBSCRIBE_INPUT_ACTIVE,
};
