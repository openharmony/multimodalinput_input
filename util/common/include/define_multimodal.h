...
#define CHKPV(cond) \
    do { \
        if ((cond) == nullptr) { \
            MMI_HILOGE("%{public}s is null", #cond); \
            return; \
        } \
    } while (0)
...
#define CHKPC(cond) \
    { \
        if ((cond) == nullptr) { \
            MMI_HILOGE("%{public}s is null, skip then continue", #cond); \
            continue; \
        } \
    }
...
#define CHKPB(cond) \
    { \
        if ((cond) == nullptr) { \
            MMI_HILOGE("%{public}s is null, skip then break", #cond); \
            break; \
        } \
    }
...
#define CHKPR(cond, r) \
    do { \
        if ((cond) == nullptr) { \
            MMI_HILOGE("%{public}s is null, return value is %{public}d", #cond, r); \
            return r; \
        } \
    } while (0)
...
#define CHKPP(cond) \
    do { \
        if ((cond) == nullptr) { \
            MMI_HILOGE("%{public}s is null, return value is null", #cond); \
            return nullptr; \
        } \
    } while (0)
...
#define CK(cond, ec) \
    do { \
        if (!(cond)) { \
            MMI_HILOGE("%{public}s, errCode:%{public}d", #cond, ec); \
        } \
    } while (0)
