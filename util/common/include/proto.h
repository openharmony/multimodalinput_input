...
enum class MmiMessageId : int32_t {
    ...
    ADD_EVENT_INTERCEPTOR,
    TOUCHPAD_EVENT_INTERCEPTOR,
    KEYBOARD_EVENT_INTERCEPTOR,
    REMOVE_EVENT_INTERCEPTOR,
    DISPLAY_INFO,
...
enum KeyboardType {
    ...
    KEYBOARD_TYPE_FULL,
    KEYBOARD_TYPE_NUMERIC_KEYPAD,
    KEYBOARD_TYPE_REMOTE_CONTROLM,
    KEYBOARD_TYPE_HANDWRITING_PEN,
};
#endif // PROTO_H