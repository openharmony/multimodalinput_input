...
inline constexpr std::string_view CREATE_STRING = "napi_create_string_utf8";
...
inline constexpr std::string_view GET_BOOL = "napi_get_value_bool";
...
inline constexpr std::string_view GET_INT32 = "napi_get_value_int32";
inline constexpr std::string_view GET_UV_LOOP = "napi_get_uv_event_loop";
inline constexpr std::string_view GET_UNDEFINED = "napi_get_undefined";
inline constexpr std::string_view GET_STRING = "napi_get_value_string_utf8";
...
inline constexpr std::string_view REFERENCE_REF = "napi_create_reference";
...
inline constexpr std::string_view GET_STRING_UTF8 = "napi_get_value_string_utf8";
