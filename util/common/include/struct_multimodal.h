...
enum MOUSE_ICON {
    ...
    MIDDLE_BTN_SOUTH = 31,
    MIDDLE_BTN_NORTH = 32,
    MIDDLE_BTN_EAST_WEST = 33,
    MIDDLE_BTN_NORTH_SOUTH = 34,
    MIDDLE_BTN_NORTH_EAST = 35,
    MIDDLE_BTN_NORTH_WEST = 36,
    MIDDLE_BTN_SOUTH_EAST = 37,
    MIDDLE_BTN_SOUTH_WEST = 38,
    MIDDLE_BTN_NORTH_SOUTH_WEST_EAST = 39,
    HORIZONTAL_TEXT_CURSOR = 40,
    CURSOR_CROSS = 41,
    CURSOR_CIRCLE = 42,
    LOADING = 43,
    RUNNING = 44,
