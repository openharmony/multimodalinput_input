...
namespace MMI {
namespace {
constexpr OHOS::HiviewDFX::HiLogLabel LABEL = { LOG_CORE, MMI_LOG_DOMAIN, "JsJoystickEvent" };
} // namespace
...
napi_value JsJoystickEvent::HandleButtonPropertyArr(napi_env env, napi_value exports)
{
    napi_property_descriptor buttonArr[] = {
        ...
        DECLARE_NAPI_STATIC_PROPERTY("THUMBL", GetNapiInt32(env, static_cast<int32_t>(Button::BUTTON_THUMBL))),
        DECLARE_NAPI_STATIC_PROPERTY("THUMBR", GetNapiInt32(env, static_cast<int32_t>(Button::BUTTON_THUMBR))),
