...
napi_value JsPointerContext::CreatePointerStyle(napi_env env, napi_value exports)
{
    ...
    CHKRP(env, napi_create_int32(env, MOUSE_ICON::MOVE, &move), CREATE_INT32);
    ...
    CHKRP(env, napi_create_int32(env, MOUSE_ICON::RESIZE_UP_DOWN, &resize_left_right), CREATE_INT32);
