...
napi_value JsInputDeviceContext::SetKeyboardRepeatDelayAsync(napi_env env, napi_callback_info info)
{
    CALL_DEBUG_ENTER;
    size_t argc = 2;
    napi_value argv[2] = { 0 };
    ...
    auto jsInputDeviceMgr = jsDev->GetJsInputDeviceMgr();
    if (argc == 1) {
        return jsInputDeviceMgr->SetKeyboardRepeatDelayAsync(env, repeatDelay);
    }
    if (!JsUtil::TypeOf(env, argv[1], napi_function)) {
        MMI_HILOGE("Callback parameter type is invalid");
        THROWERR_API9(env, COMMON_PARAMETER_ERROR, "callback", "function");
    ...
    return jsInputDeviceMgr->SetKeyboardRepeatDelayAsync(env, repeatDelay, argv[1]);
}

napi_value JsInputDeviceContext::SetKeyboardRepeatRateAsync(napi_env env, napi_callback_info info)
{
    CALL_DEBUG_ENTER;
    size_t argc = 2;
    napi_value argv[2] = { 0 };
    ...
    auto jsInputDeviceMgr = jsDev->GetJsInputDeviceMgr();
    if (argc == 1) {
        return jsInputDeviceMgr->SetKeyboardRepeatRateAsync(env, repeatRate);
    }
    if (!JsUtil::TypeOf(env, argv[1], napi_function)) {
        MMI_HILOGE("Callback parameter type is invalid");
        THROWERR_API9(env, COMMON_PARAMETER_ERROR, "callback", "function");
    ...
    return jsInputDeviceMgr->SetKeyboardRepeatRateAsync(env, repeatRate, argv[1]);
}

napi_value JsInputDeviceContext::GetKeyboardRepeatDelayAsync(napi_env env, napi_callback_info info)
{
    CALL_DEBUG_ENTER;
    size_t argc = 1;
    napi_value argv[1] = { 0 };
    ...
    auto jsInputDeviceMgr = jsDev->GetJsInputDeviceMgr();
    if (argc < 1) {
        return jsInputDeviceMgr->GetKeyboardRepeatDelayAsync(env);
    }
    if (!JsUtil::TypeOf(env, argv[0], napi_function)) {
        MMI_HILOGE("Callback parameter type is invalid");
        THROWERR_API9(env, COMMON_PARAMETER_ERROR, "callback", "function");
    ...
    return jsInputDeviceMgr->GetKeyboardRepeatDelayAsync(env, argv[0]);
}

napi_value JsInputDeviceContext::GetKeyboardRepeatRateAsync(napi_env env, napi_callback_info info)
{
    CALL_DEBUG_ENTER;
    size_t argc = 1;
    napi_value argv[1] = { 0 };
    ...
    auto jsInputDeviceMgr = jsDev->GetJsInputDeviceMgr();
    if (argc < 1) {
        return jsInputDeviceMgr->GetKeyboardRepeatRateAsync(env);
    }
    if (!JsUtil::TypeOf(env, argv[0], napi_function)) {
        MMI_HILOGE("Callback parameter type is invalid");
        THROWERR_API9(env, COMMON_PARAMETER_ERROR, "callback", "function");
    ...
    return jsInputDeviceMgr->GetKeyboardRepeatRateAsync(env, argv[0]);
}

napi_value JsInputDeviceContext::GetKeyboardTypeAsync(napi_env env, napi_callback_info info)
{
    CALL_DEBUG_ENTER;
    size_t argc = 2;
    napi_value argv[2] = { 0 };
    ...
    CHKPP(jsInputDeviceMgr);
    if (argc == 1) {
        return jsInputDeviceMgr->GetKeyboardTypeAsync(env, id);
    }
    if (!JsUtil::TypeOf(env, argv[1], napi_function)) {
        MMI_HILOGE("Second parameter type error");
        THROWERR_API9(env, COMMON_PARAMETER_ERROR, "callback", "function");
    ...
    return jsInputDeviceMgr->GetKeyboardTypeAsync(env, id, argv[1]);
}

napi_value JsInputDeviceContext::GetDeviceIdsAsync(napi_env env, napi_callback_info info)
{
    CALL_DEBUG_ENTER;
    size_t argc = 1;
    napi_value argv[1] = { 0 };
    ...
    auto jsInputDeviceMgr = jsIds->GetJsInputDeviceMgr();
    if (argc < 1) {
        return jsInputDeviceMgr->GetDeviceIdsAsync(env);
    }
    if (!JsUtil::TypeOf(env, argv[0], napi_function)) {
        THROWERR(env, "The first parameter type is wrong");
        return nullptr;
    }
    return jsInputDeviceMgr->GetDeviceIdsAsync(env, argv[0]);
}
