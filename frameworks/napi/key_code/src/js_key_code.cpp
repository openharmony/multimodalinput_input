...
napi_value JsKeyCode::Export(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_STATIC_PROPERTY("KEYCODE_DAGGER_PRESS", GetNapiInt32(env, KeyEvent::KEYCODE_DAGGER_PRESS)),
        DECLARE_NAPI_STATIC_PROPERTY("KEYCODE_DAGGER_CLICK", GetNapiInt32(env, KeyEvent::KEYCODE_DAGGER_CLICK)),
        DECLARE_NAPI_STATIC_PROPERTY("KEYCODE_DAGGER_LONG_PRESS", GetNapiInt32(env, KeyEvent::KEYCODE_DAGGER_LONG_PRESS)),
    };
