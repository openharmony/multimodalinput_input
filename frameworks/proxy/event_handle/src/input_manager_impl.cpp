...
{
    CHKPR(monitor, ERROR_NULL_POINTER, InputEventMonitorManager::INVALID_MONITOR_ID);
...
{
    CHKPR(consumer, ERROR_NULL_POINTER, InputEventMonitorManager::INVALID_MONITOR_ID);
