...
{
    RunShellUtil runCommand;
    std::string log1 = "CheckMousePointEvent_001";
    std::vector<std::string> beforeRunLogs;
    ASSERT_TRUE(runCommand.RunShellCommand(log1, beforeRunLogs) == RET_OK);
...
{
    RunShellUtil runCommand;
    std::string log1 = "CheckMousePointEvent_002";
    std::vector<std::string> beforeRunLogs;
    ASSERT_TRUE(runCommand.RunShellCommand(log1, beforeRunLogs) == RET_OK);
...
{
    RunShellUtil runCommand;
    std::string log1 = "CheckMousePointEvent_003";
    std::vector<std::string> beforeRunLogs;
    ASSERT_TRUE(runCommand.RunShellCommand(log1, beforeRunLogs) == RET_OK);
	...
	pointerEvent1->SetPointerAction(PointerEvent::POINTER_ACTION_BUTTON_UP);
...
{
    RunShellUtil runCommand;
    std::string log1 = "CheckMousePointEvent_004";
    std::vector<std::string> beforeRunLogs;
    ASSERT_TRUE(runCommand.RunShellCommand(log1, beforeRunLogs) == RET_OK);
...
{
    RunShellUtil runCommand;
    std::string log1 = "CheckMousePointEvent_005";
    std::vector<std::string> beforeRunLogs;
    ASSERT_TRUE(runCommand.RunShellCommand(log1, beforeRunLogs) == RET_OK);
...
{
	RunShellUtil runCommand;
    std::string log1 = "CheckTouchPointEvent_001";
    std::vector<std::string> beforeRunLogs;
    ASSERT_TRUE(runCommand.RunShellCommand(log1, beforeRunLogs) == RET_OK);
...
{
	RunShellUtil runCommand;
    std::string log1 = "CheckTouchPointEvent_002";
    std::vector<std::string> beforeRunLogs;
    ASSERT_TRUE(runCommand.RunShellCommand(log1, beforeRunLogs) == RET_OK);
    ...
    auto pointerEvent3 = PointerEvent::Create();
	pointerEvent3->SetSourceType(PointerEvent::SOURCE_TYPE_TOUCHSCREEN);
	pointerEvent3->SetPointerId(0);
	pointerEvent3->SetPointerAction(PointerEvent::POINTER_ACTION_CANCEL);
	pointerEvent3->SetButtonId(PointerEvent::BUTTON_NONE);
    item.SetPointerId(0);
	item.SetDownTime(0);
    pointerEvent3->AddPointerItem(item);
...
{
	RunShellUtil runCommand;
    std::string log1 = "CheckTouchPointEvent_003";
    std::vector<std::string> beforeRunLogs;
    ASSERT_TRUE(runCommand.RunShellCommand(log1, beforeRunLogs) == RET_OK);
...
{
	RunShellUtil runCommand;
    std::string log1 = "CheckTouchPointEvent_004";
    std::vector<std::string> beforeRunLogs;
    ASSERT_TRUE(runCommand.RunShellCommand(log1, beforeRunLogs) == RET_OK);
...
{
	RunShellUtil runCommand;
    std::string log1 = "CheckTouchPointEvent_005";
    std::vector<std::string> beforeRunLogs;
    ASSERT_TRUE(runCommand.RunShellCommand(log1, beforeRunLogs) == RET_OK);
