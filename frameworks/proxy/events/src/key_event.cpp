...
const std::map <int32_t, std::string> KEYCODE_TO_STRING = {
    ...
    {KeyEvent::KEYCODE_MOUSE_ASSISTANT, "KEYCODE_MOUSE_ASSISTANT"},
    {KeyEvent::KEYCODE_MOUSE_INTELLIGENCE_SELECTION, "KEYCODE_MOUSE_INTELLIGENCE_SELECTION"},
    {KeyEvent::KEYCODE_AOD_SINGLE_CLICK, "KEYCODE_AOD_SINGLE_CLICK"},
    ...
    {KeyEvent::KEYCODE_PEELING, "KEYCODE_PEELING"},
    ...
    {KeyEvent::KEYCODE_DAGGER_CLICK, "KEYCODE_DAGGER_CLICK"},
    {KeyEvent::KEYCODE_DAGGER_DOUBLE_CLICK, "KEYCODE_DAGGER_DOUBLE_CLICK"},
    {KeyEvent::KEYCODE_DAGGER_LONG_PRESS, "KEYCODE_DAGGER_LONG_PRESS"},
    {KeyEvent::KEYCODE_KEY_PEN_AIR_MOUSE, "KEYCODE_KEY_PEN_AIR_MOUSE"},
    {KeyEvent::KEYCODE_KEY_PEN_LIGHT_PINCH, "KEYCODE_KEY_PEN_LIGHT_PINCH"},
    {KeyEvent::KEYCODE_KEY_PEN_AI, "KEYCODE_KEY_PEN_AI"},
    {KeyEvent::KEYCODE_KEY_PEN_END_CLICK, "KEYCODE_KEY_PEN_END_CLICK"},
    {KeyEvent::KEYCODE_KEY_PEN_END_DOUBLE_CLICK, "KEYCODE_KEY_PEN_END_DOUBLE_CLICK"},
    {KeyEvent::KEYCODE_KEY_PEN_MODE_SWITCH, "KEYCODE_KEY_PEN_MODE_SWITCH"},
    {KeyEvent::KEYCODE_AOD_SLIDE_UNLOCK, "KEYCODE_AOD_SLIDE_UNLOCK"},
    {KeyEvent::KEYCODE_RECENT, "KEYCODE_RECENT"},
    ...
    {KeyEvent::KEYCODE_BACK_PANEL_DOUBLE_TAP, "KEYCODE_BACK_PANEL_DOUBLE_TAP"},
    {KeyEvent::KEYCODE_FINGERPRINT_SLIDE_UP, "KEYCODE_FINGERPRINT_SLIDE_UP"},
    {KeyEvent::KEYCODE_FINGERPRINT_SLIDE_DOWN, "KEYCODE_FINGERPRINT_SLIDE_DOWN"},
    {KeyEvent::KEYCODE_PTZ_CLICK, "KEYCODE_PTZ_CLICK"},
    {KeyEvent::KEYCODE_PTZ_FOCUS_LEFT, "KEYCODE_PTZ_FOCUS_LEFT"},
    {KeyEvent::KEYCODE_PTZ_FOCUS_RIGHT, "KEYCODE_PTZ_FOCUS_RIGHT"},
    {KeyEvent::KEYCODE_PTZ_EXPOSE_LEFT, "KEYCODE_PTZ_EXPOSE_LEFT"},
    {KeyEvent::KEYCODE_PTZ_EXPOSE_RIGHT, "KEYCODE_PTZ_EXPOSE_RIGHT"},
    {KeyEvent::KEYCODE_PTZ_SHUTTER_LEFT, "KEYCODE_PTZ_SHUTTER_LEFT"},
    {KeyEvent::KEYCODE_PTZ_SHUTTER_RIGHT, "KEYCODE_PTZ_SHUTTER_RIGHT"},
    {KeyEvent::KEYCODE_PTZ_APERTURE_LEFT, "KEYCODE_PTZ_APERTURE_LEFT"},
    {KeyEvent::KEYCODE_PTZ_APERTURE_RIGHT, "KEYCODE_PTZ_APERTURE_RIGHT"},
    {KeyEvent::KEYCODE_KEY_LIFT_PEN, "KEYCODE_KEY_LIFT_PEN"},
    {KeyEvent::KEYCODE_KEY_DOWN_PEN, "KEYCODE_KEY_DOWN_PEN"},
#else
    {KeyEvent::KEYCODE_FN, "KEYCODE_FN"},
    {KeyEvent::KEYCODE_POWER, "KEYCODE_POWER"},
...
const int32_t KeyEvent::KEYCODE_MOUSE_ASSISTANT = 2732;
const int32_t KeyEvent::KEYCODE_MOUSE_INTELLIGENCE_SELECTION = 2733;
const int32_t KeyEvent::KEYCODE_AOD_SINGLE_CLICK = 2740;
...
const int32_t KeyEvent::KEYCODE_DAGGER_CLICK = 3211;
const int32_t KeyEvent::KEYCODE_DAGGER_DOUBLE_CLICK = 3212;
const int32_t KeyEvent::KEYCODE_DAGGER_LONG_PRESS = 3213;
const int32_t KeyEvent::KEYCODE_KEY_PEN_AIR_MOUSE = 3214;
const int32_t KeyEvent::KEYCODE_KEY_PEN_LIGHT_PINCH = 3215;
const int32_t KeyEvent::KEYCODE_KEY_PEN_AI = 3216;
...
const int32_t KeyEvent::KEYCODE_PTZ_CLICK = 3235;
const int32_t KeyEvent::KEYCODE_PTZ_FOCUS_LEFT = 3236;
const int32_t KeyEvent::KEYCODE_PTZ_FOCUS_RIGHT = 3237;
const int32_t KeyEvent::KEYCODE_PTZ_EXPOSE_LEFT = 3238;
const int32_t KeyEvent::KEYCODE_PTZ_EXPOSE_RIGHT = 3239;
const int32_t KeyEvent::KEYCODE_PTZ_SHUTTER_LEFT = 3240;
const int32_t KeyEvent::KEYCODE_PTZ_SHUTTER_RIGHT = 3241;
const int32_t KeyEvent::KEYCODE_PTZ_APERTURE_LEFT = 3242;
const int32_t KeyEvent::KEYCODE_PTZ_APERTURE_RIGHT = 3243;
const int32_t KeyEvent::KEYCODE_PEN_WRITING_MOUSE = 3251;
const int32_t KeyEvent::KEYCODE_WRIST_TURN = 16777216;  // 0x01000000
const int32_t KeyEvent::KEYCODE_PEELING = 16777217;
const int32_t KeyEvent::KEYCODE_BACK_PANEL_DOUBLE_TAP = 16842752;  // 0x01010000
const int32_t KeyEvent::KEYCODE_KEY_LIFT_PEN = 16842753;
const int32_t KeyEvent::KEYCODE_KEY_DOWN_PEN = 16842754;
...
const int32_t KeyEvent::KEYCODE_RECENT = 10011;
const int32_t KeyEvent::KEYCODE_FLOATING_BACK = 10012;
...
const uint32_t KeyEvent::BUSINESS_EXCLUSIVE_KEY_MASK = 0x00FF0000;
const uint32_t KeyEvent::BUSINESS_EXCLUSIVE_KEY_FLAG = 0x00010000;
const int32_t KeyEvent::KEYCODE_BIZ_EXCLUSIVE_MIN = 16842752;   // 0x01010000
const int32_t KeyEvent::KEYCODE_BIZ_EXCLUSIVE_MAX = 16859135;   // 0x0101FFFF
...
void KeyEvent::AddReleasedKeyItems(const KeyItem& keyItem)
{
    RemoveReleasedKeyItems(keyItem);
    AddPressedKeyItems(keyItem);
}
...
bool KeyEvent::IsValidKeyItem() const
{
    ...
    for (auto it = keys_.begin(); it != keys_.end(); ++it) {
        if (it->GetKeyCode() == keyCode) {
            if (++sameKeyCodeNum > 1) {
                MMI_HILOGE("Keyitems code is not unique with keyEvent code");
                return false;
            }
        }
        ...
        if (action == KEY_ACTION_UP && it->IsPressed() == false) {
            if (it->GetKeyCode() != keyCode) {
                MMI_HILOGE("Invalid when isPressed is false");
                return false;
            }
        }
        ...
        for (++item; item != keys_.end(); item++) {
            if (it->GetKeyCode() == item->GetKeyCode()) {
                MMI_HILOGE("Keyitems code exist same items");
                return false;
            }
        }
    }
    ...
    if (sameKeyCodeNum == 0) {
        MMI_HILOGE("Keyitems code is not exist equal item with keyEvent code");
        return false;
    }
    return true;
}
...
bool KeyEvent::Marshalling(Parcel &out) const
{
...
{
    KeyEvent *data = new (std::nothrow) KeyEvent(InputEvent::EVENT_TYPE_KEY);
