    ...
    static void Print(const std::shared_ptr<PointerEvent> event, const LogHeader &lh)
    {
        ...
        for (const auto &pointerId : pointerIds) {
            ...
            if (!IsBetaVersion()) {
                ...
                if (event->HasFlag(InputEvent::EVENT_FLAG_PRIVACY_MODE)) {
                    ...
                    MMI_HILOG_HEADER(LOG_DEBUG, lh,"PI:%{public}d, DT:%{public}" PRId64 ", IP:%{public}d, DX:%{public}d, DY:%{public}d"
                        ", WX:%{public}d, WY:%{public}d, W:%{public}d, H:%{public}d, TX:%{public}.2f, TY:%{public}.2f, TDX:%{public}d,"
                        "TDY:%{public}d, ToolWX:%{public}d, ToolWY:%{public}d, ToolW:%{public}d, ToolH:%{public}d, P:%{public}.2f,"
            ...
            if (!IsBetaVersion()) {
                ...
                if (event->HasFlag(InputEvent::EVENT_FLAG_PRIVACY_MODE)) {
                    MMI_HILOG_HEADER(LOG_DEBUG, lh,
                        "PI:%{public}d, DT:%{public}" PRId64 ", IP:%{public}d, DX:%d, DY:%d, WX:%d, WY:%d, W:%{public}d,"
                        "H:%{public}d, TX:%.2f, TY:%.2f, TDX:%d, TDY:%d, ToolWX:%d, ToolWY:%d, ToolW:%{public}d, ToolH:%{public}d, "
                        "P:%{public}.2f, ToolType:%{public}d, LA:%{public}d, SA:%{public}d, RawDx:%d, RawDy:%d",
                    ...
                    MMI_HILOG_HEADER(LOG_DEBUG, lh,
                        ...
                        "P:%{public}.2f, ToolType:%{public}d, LA:%{public}d, SA:%{public}d, RawDx:%{public}d, RawDy:%{public}d",
                        pointerId, item.GetDownTime(), item.IsPressed(), item.GetDisplayX(),
                        item.GetDisplayY(), item.GetWindowX(), item.GetWindowY(), item.GetWidth(), item.GetHeight(),
                        item.GetTiltX(), item.GetTiltY(), item.GetToolDisplayX(), item.GetToolDisplayY(),
                        item.GetToolWindowX(), item.GetToolWindowY(), item.GetToolWidth(), item.GetToolHeight(),
