    ...
    PriorityLevel priorityLevel)
{
    ...
    return InputInterMgr->AddInterceptor(interceptor, HANDLE_EVENT_TYPE_ALL, priorityLevel);
#else
    ...
    PriorityLevel priorityLevel)
{
    ...
    return InputInterMgr->AddInterceptor(consumer, HANDLE_EVENT_TYPE_KEY, priorityLevel);
#else
