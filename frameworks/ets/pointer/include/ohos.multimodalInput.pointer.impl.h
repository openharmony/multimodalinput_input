...
enum PointerStyleCode {
    ...
    RUNNING_LEFT_IMPL = 45,
    RUNNING_RIGHT_IMPL = 46,
    AECH_DEVELOPER_DEFINED_ICON_IMPL = 47,
    SCREENRECORDER_CURSOR_IMPL = 48,
    LASER_CURSOR_IMPL = 49,
    LASER_CURSOR_DOT_IMPL = 50,
    LASER_CURSOR_DOT_RED_IMPL = 51,
    DEVELOPER_DEFINED_ICON_IMPL = -100,
};
